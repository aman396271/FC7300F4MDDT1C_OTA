 ...
 * @{
 */
#define CORDIC_SIN_COS_ID       0x00
#define CORDIC_RADICAL_ADD_ID   0x01
#define CORDIC_ARCTAN_F_ID      0x02
#define CORDIC_ARCTAN_ID        0x03
#define CORDIC_SINH_COSH_ID     0x04
#define CORDIC_RADICAL_SUB_ID   0x05
#define CORDIC_ARCTANH_ID       0x06
#define CORDIC_EXTENDED_LN_ID   0x07
#define CORDIC_EXTENDED_SQRT_ID 0x08
/**
 * @}
 */
 ...
 */
CORDIC_Radical_Type Cordic_Radical_Add(CORDIC_InstanceType eInstance, const float x, const float y);
 ...
 * @return A CORDIC_Arctan_Type representing the computed arctangent value.
 */
CORDIC_Arctan_Type Cordic_Arctan(CORDIC_InstanceType eInstance, const int32_t x, const int32_t y);
 ...
 */
CORDIC_Radical_Type Cordic_Radical_Sub(CORDIC_InstanceType eInstance, const float x, const float y);

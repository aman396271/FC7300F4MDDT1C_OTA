...
#ifdef DMA_HAVE_GPR
/**
 * @brief Set Channel Group 0 Priority and clear Group 1 Priority
 *
 * @param pDma the base address of the DMA instance
 */
LOCAL_INLINE void DMA_HWA_SetGPR0PRIClearGPR1PRI(DMA_Type *const pDma)
{
    pDma->CR = (pDma->CR & ~(DMA_CR_GRP1PRI_MASK | DMA_CR_GPR0PRI_MASK)) | DMA_CR_GPR0PRI_MASK;
}

/**
 * @brief Set Channel Group 1 Priority and clear Group 0 Priority
 *
 * @param pDma the base address of the DMA instance
 */
LOCAL_INLINE void DMA_HWA_SetGPR1PRIClearGPR0PRI(DMA_Type *const pDma)
{
    pDma->CR = (pDma->CR & ~(DMA_CR_GRP1PRI_MASK | DMA_CR_GPR0PRI_MASK)) | DMA_CR_GRP1PRI_MASK;
}
#endif
...
{
#if (DMA_UME_COUNT == 2U)
    uint32_t u32TmpVal = (pDma->UME[u8Channel/16U] & ((uint32_t)DMA_UME_SUME0_MASK << (2U * (u8Channel % 16U)))) >>
                         (DMA_UME_SUME0_SHIFT + 2U * (u8Channel % 16U));
#elif (DMA_UME_COUNT == 1U)
    uint32_t u32TmpVal = (pDma->UME[u8Channel/16U] & ((uint32_t)DMA_UME_SUME0_MASK << (2U * (u8Channel % 16U)))) >>
    	                         (DMA_UME_SUME0_SHIFT + 2U * (u8Channel % 16U));
#endif
    return (bool)((u32TmpVal != 0U) ? true : false);
...
{
#if (DMA_UME_COUNT == 2U)
    uint32_t u32TmpVal = (pDma->UME[u8Channel/16U] & ((uint32_t)DMA_UME_DUME0_MASK << (2U * (u8Channel % 16U)))) >>
                         (DMA_UME_DUME0_SHIFT + 2U * (u8Channel % 16U));
#elif (DMA_UME_COUNT == 1U)
    uint32_t u32TmpVal = (pDma->UME[u8Channel/16U] & ((uint32_t)DMA_UME_DUME0_MASK << (2U * (u8Channel % 16U)))) >>
                             (DMA_UME_DUME0_SHIFT + 2U * (u8Channel % 16U));
#endif
...
{
#if (DMA_UME_COUNT == 2U)
    pDma->UME[u8Channel/16U] = (pDma->UME[u8Channel/16U] & ~((DMA_UME_DUME0_MASK | DMA_UME_SUME0_MASK) << (2U * (u8Channel % 16U)))) |
                 ((DMA_UME_DUME0(bEnableDestModulo) | DMA_UME_SUME0(bEnableSrcModulo)) << (2U * (u8Channel % 16U)));
#elif (DMA_UME_COUNT == 1U)
    pDma->UME[u8Channel / 16U] = (pDma->UME[u8Channel / 16U] & ~((uint32_t)(DMA_UME_DUME0_MASK | DMA_UME_SUME0_MASK) << (2U * (u8Channel % 16U)))) |
    	                                ((DMA_UME_DUME0(bEnableDestModulo) | DMA_UME_SUME0(bEnableSrcModulo)) << (2U * (u8Channel % 16U)));
#endif
}
...
{
#if (DMA_UME_COUNT == 2U)
    uint32_t u32TmpVal = (pDma->UMO[u8Selection] & DMA_UMO_SUMO_MASK) >> DMA_UMO_SUMO_SHIFT;
#elif (DMA_UME_COUNT == 1U)
    uint32_t u32TmpVal = (pDma->UMO[u8Selection] & DMA_UMO_SUMO_MASK) >> DMA_UMO_SUMO_SHIFT;
#endif
    return (uint16_t)u32TmpVal;
...
{
#if (DMA_UME_COUNT == 2U)
    uint32_t u32TmpVal = (pDma->UMO[u8Selection] & DMA_UMO_DUMO_MASK) >> DMA_UMO_DUMO_SHIFT;
#elif (DMA_UME_COUNT == 1U)
    uint32_t u32TmpVal = (pDma->UMO[u8Selection] & DMA_UMO_DUMO_MASK) >> DMA_UMO_DUMO_SHIFT;
#endif
    return (uint16_t)u32TmpVal;
...
{
#if (DMA_UME_COUNT == 2U)
    pDma->UMO[u8Selection] = DMA_UMO_SUMO(u16SrcModulo) | DMA_UMO_DUMO(u16DestModulo);
#elif (DMA_UME_COUNT == 1U)
    pDma->UMO[u8Selection] = DMA_UMO_SUMO(u16SrcModulo) | DMA_UMO_DUMO(u16DestModulo);
#endif
}
...
{
    uint8_t u8TmpVal = pDma->CHPRI[DMA_CH_TO_DCHPRI(u8Channel)];
    return u8TmpVal;
}
...
{
    pDma->CHPRI[DMA_CH_TO_DCHPRI(u8Channel)] = u8Priority;
}
 ...
 *
 * @param pDma the base address of the DMA instance
 * @return uint32_t status of the DMA Monitor Checker
 */
LOCAL_INLINE uint32_t DMA_HWA_GetMonitorCheckerErrStatus(DMA_Type *const pDma)
{

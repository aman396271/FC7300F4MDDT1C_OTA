#ifndef _MODULE_FTU_gmbhdijq132_REGS_H_FTU_H_
#define _MODULE_FTU_gmbhdijq132_REGS_H_FTU_H_
...
//#define FTU_IRQS                                 {FTU0_IRQn, FTU1_IRQn, FTU2_IRQn, FTU3_IRQn, FTU4_IRQn, FTU5_IRQn, FTU6_IRQn, FTU7_IRQn}
...
#define FTU_SC_FTUCNTSEL_MASK          0x1000u
#define FTU_SC_FTUCNTSEL_SHIFT         12u
#define FTU_SC_FTUCNTSEL_WIDTH         1u
#define FTU_SC_FTUCNTSEL(x)            (((uint32_t)(((uint32_t)(x))<<FTU_SC_FTUCNTSEL_SHIFT))&FTU_SC_FTUCNTSEL_MASK)
...
#define FTU_SC_FDUTYCTL_MASK           0x400u
#define FTU_SC_FDUTYCTL_SHIFT          10u
#define FTU_SC_FDUTYCTL_WIDTH          1u
#define FTU_SC_FDUTYCTL(x)             (((uint32_t)(((uint32_t)(x))<<FTU_SC_FDUTYCTL_SHIFT))&FTU_SC_FDUTYCTL_MASK)
...
/* SC Reg Mask */
#define FTU_SC_MASK                    0xCFFFDFFFu
...
/* CnSC Bit Fields */
#define FTU_CnSC_ICEXP_NUM_ICM_ECNT_MASK 0xFF000000u
#define FTU_CnSC_ICEXP_NUM_ICM_ECNT_SHIFT 24u
#define FTU_CnSC_ICEXP_NUM_ICM_ECNT_WIDTH 8u
#define FTU_CnSC_ICEXP_NUM_ICM_ECNT(x) (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_ICEXP_NUM_ICM_ECNT_SHIFT))&FTU_CnSC_ICEXP_NUM_ICM_ECNT_MASK)
#define FTU_CnSC_ICM_SINGLE_MASK       0x40000u
#define FTU_CnSC_ICM_SINGLE_SHIFT      18u
#define FTU_CnSC_ICM_SINGLE_WIDTH      1u
#define FTU_CnSC_ICM_SINGLE(x)         (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_ICM_SINGLE_SHIFT))&FTU_CnSC_ICM_SINGLE_MASK)
#define FTU_CnSC_ICDPM_START_MASK      0x20000u
#define FTU_CnSC_ICDPM_START_SHIFT     17u
#define FTU_CnSC_ICDPM_START_WIDTH     1u
#define FTU_CnSC_ICDPM_START(x)        (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_ICDPM_START_SHIFT))&FTU_CnSC_ICDPM_START_MASK)
#define FTU_CnSC_ICM_CONT_MASK         0x10000u
#define FTU_CnSC_ICM_CONT_SHIFT        16u
#define FTU_CnSC_ICM_CONT_WIDTH        1u
#define FTU_CnSC_ICM_CONT(x)           (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_ICM_CONT_SHIFT))&FTU_CnSC_ICM_CONT_MASK)
#define FTU_CnSC_ICM_MODE_MASK         0xE000u
#define FTU_CnSC_ICM_MODE_SHIFT        13u
#define FTU_CnSC_ICM_MODE_WIDTH        3u
#define FTU_CnSC_ICM_MODE(x)           (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_ICM_MODE_SHIFT))&FTU_CnSC_ICM_MODE_MASK)
#define FTU_CnSC_FDLYSEL_MASK          0x1800u
#define FTU_CnSC_FDLYSEL_SHIFT         11u
#define FTU_CnSC_FDLYSEL_WIDTH         2u
#define FTU_CnSC_FDLYSEL(x)            (((uint32_t)(((uint32_t)(x))<<FTU_CnSC_FDLYSEL_SHIFT))&FTU_CnSC_FDLYSEL_MASK)
...
/* C0SC Reg Mask */
#define FTU_CnSC_MASK                  0xFF07FFFFu
...
#define FTU_STATUS_CHNICOF(x)          (((uint32_t)(((uint32_t)(x))<<FTU_STATUS_CHNICOF_SHIFT))&FTU_STATUS_CHNICOF_MASK)
...
/* TRIGCONF Bit Fields */
#define FTU_TRIGCONF_CH067_DO_TRIG_CTRL_MASK 0x380000u
#define FTU_TRIGCONF_CH067_DO_TRIG_CTRL_SHIFT 19u
#define FTU_TRIGCONF_CH067_DO_TRIG_CTRL_WIDTH 3u
#define FTU_TRIGCONF_CH067_DO_TRIG_CTRL(x) (((uint32_t)(((uint32_t)(x))<<FTU_TRIGCONF_CH067_DO_TRIG_CTRL_SHIFT))&FTU_TRIGCONF_CH067_DO_TRIG_CTRL_MASK)
#define FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL_MASK 0x70000u
#define FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL_SHIFT 16u
#define FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL_WIDTH 3u
#define FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL(x) (((uint32_t)(((uint32_t)(x))<<FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL_SHIFT))&FTU_TRIGCONF_CH067_ICEVENT_TRIG_CTRL_MASK)
#define FTU_TRIGCONF_TRIGIN_LVLSEL_MASK 0x2000u
#define FTU_TRIGCONF_TRIGIN_LVLSEL_SHIFT 13u
#define FTU_TRIGCONF_TRIGIN_LVLSEL_WIDTH 1u
#define FTU_TRIGCONF_TRIGIN_LVLSEL(x)  (((uint32_t)(((uint32_t)(x))<<FTU_TRIGCONF_TRIGIN_LVLSEL_SHIFT))&FTU_TRIGCONF_TRIGIN_LVLSEL_MASK)
#define FTU_TRIGCONF_CH0TO2_SRCSEL_MASK 0x1C00u
#define FTU_TRIGCONF_CH0TO2_SRCSEL_SHIFT 10u
#define FTU_TRIGCONF_CH0TO2_SRCSEL_WIDTH 3u
#define FTU_TRIGCONF_CH0TO2_SRCSEL(x)  (((uint32_t)(((uint32_t)(x))<<FTU_TRIGCONF_CH0TO2_SRCSEL_SHIFT))&FTU_TRIGCONF_CH0TO2_SRCSEL_MASK)
...
/* TRIGCONF Reg Mask */
#define FTU_TRIGCONF_MASK              0x003F3FFFu
...
/* FLTCTRL Reg Mask */
#define FTU_FLTCTRL_MASK               0x00FF8F33u
...
/* FLTPOL Reg Mask */
#define FTU_FLTPOL_MASK                0x00FF0003u

#ifndef _MODULE_CRC_gmbhdijq155_REGS_H_CRC_H_
#define _MODULE_CRC_gmbhdijq155_REGS_H_CRC_H_
...
typedef struct {
  ...
  __IO uint32_t POLY                          ; /* Polynomial Register, offset: 0x4 */
  __IO uint32_t CR                            ; /* Control Register, offset: 0x8 */
  __IO uint32_t SDAT                          ; /* Data Bit Swap Register, offset: 0xC */
...
///** Number of interrupt vector arrays for the CRC module. */
//#define CRC_IRQS_ARR_COUNT                       (1u)
///** Number of interrupt channels for the CRC module. */
//#define CRC_IRQS_CH_COUNT                        (1u)
///** Interrupt vectors for the CRC peripheral type */
//#define CRC_IRQS                                 {CRC_IRQn}

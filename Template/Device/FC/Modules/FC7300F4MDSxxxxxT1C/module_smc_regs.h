#ifndef _MODULE_SMC_gmbhdijq158_REGS_H_SMC_H_
#define _MODULE_SMC_gmbhdijq158_REGS_H_SMC_H_
...
typedef struct {
  ...
  __IO uint32_t ADC_PD0_CFG                   ; /* ADC PD0 Configuration Register, offset: 0x8C */
  __IO uint32_t TSTMP0_CLK_CFG                ; /* TSTMP0 Clock Configuration Register, offset: 0x90 */
       uint8_t  RESERVED_4[4];
  __IO uint32_t ADC0_CFG3                     ; /* ADC0 Configuration3 Register, offset: 0x98 */
  __IO uint32_t ADC1_CFG2                     ; /* ADC1 Configuration2 Register, offset: 0x9C */
  __IO uint32_t ADC1_CFG3                     ; /* ADC1 Configuration3 Register, offset: 0xA0 */
...
/* ADC1_CFG0 Bit Fields */
#define SMC_ADC1_CFG0_SGCMP_EN_MASK    0x80000000u
#define SMC_ADC1_CFG0_SGCMP_EN_SHIFT   31u
#define SMC_ADC1_CFG0_SGCMP_EN_WIDTH   1u
#define SMC_ADC1_CFG0_SGCMP_EN(x)      (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG0_SGCMP_EN_SHIFT))&SMC_ADC1_CFG0_SGCMP_EN_MASK)
#define SMC_ADC1_CFG0_SGCMP_IEN_MASK   0x40000000u
#define SMC_ADC1_CFG0_SGCMP_IEN_SHIFT  30u
#define SMC_ADC1_CFG0_SGCMP_IEN_WIDTH  1u
#define SMC_ADC1_CFG0_SGCMP_IEN(x)     (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG0_SGCMP_IEN_SHIFT))&SMC_ADC1_CFG0_SGCMP_IEN_MASK)
#define SMC_ADC1_CFG0_SGCMP_FLAG_CLR_MASK 0x8000000u
#define SMC_ADC1_CFG0_SGCMP_FLAG_CLR_SHIFT 27u
#define SMC_ADC1_CFG0_SGCMP_FLAG_CLR_WIDTH 1u
#define SMC_ADC1_CFG0_SGCMP_FLAG_CLR(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG0_SGCMP_FLAG_CLR_SHIFT))&SMC_ADC1_CFG0_SGCMP_FLAG_CLR_MASK)
#define SMC_ADC1_CFG0_SGCMP_REF_SEL_MASK 0xFFFFFFu
#define SMC_ADC1_CFG0_SGCMP_REF_SEL_SHIFT 0u
#define SMC_ADC1_CFG0_SGCMP_REF_SEL_WIDTH 24u
#define SMC_ADC1_CFG0_SGCMP_REF_SEL(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG0_SGCMP_REF_SEL_SHIFT))&SMC_ADC1_CFG0_SGCMP_REF_SEL_MASK)
/* ADC1_CFG0 Reg Mask */
#define SMC_ADC1_CFG0_MASK             0xC8FFFFFFu

/* ADC1_CFG1 Bit Fields */
#define SMC_ADC1_CFG1_SGCMP_ACT_SEL_MASK 0xFFFFFFu
#define SMC_ADC1_CFG1_SGCMP_ACT_SEL_SHIFT 0u
#define SMC_ADC1_CFG1_SGCMP_ACT_SEL_WIDTH 24u
#define SMC_ADC1_CFG1_SGCMP_ACT_SEL(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG1_SGCMP_ACT_SEL_SHIFT))&SMC_ADC1_CFG1_SGCMP_ACT_SEL_MASK)
/* ADC1_CFG1 Reg Mask */
#define SMC_ADC1_CFG1_MASK             0x00FFFFFFu

/* ADC1_RES Bit Fields */
#define SMC_ADC1_RES_SGCMP_ON_MASK     0x80000000u
#define SMC_ADC1_RES_SGCMP_ON_SHIFT    31u
#define SMC_ADC1_RES_SGCMP_ON_WIDTH    1u
#define SMC_ADC1_RES_SGCMP_ON(x)       (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_RES_SGCMP_ON_SHIFT))&SMC_ADC1_RES_SGCMP_ON_MASK)
#define SMC_ADC1_RES_SGCMP_FLAG_MASK   0x40000000u
#define SMC_ADC1_RES_SGCMP_FLAG_SHIFT  30u
#define SMC_ADC1_RES_SGCMP_FLAG_WIDTH  1u
#define SMC_ADC1_RES_SGCMP_FLAG(x)     (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_RES_SGCMP_FLAG_SHIFT))&SMC_ADC1_RES_SGCMP_FLAG_MASK)
#define SMC_ADC1_RES_SGCMP_RES_MASK    0xFFFFFFu
#define SMC_ADC1_RES_SGCMP_RES_SHIFT   0u
#define SMC_ADC1_RES_SGCMP_RES_WIDTH   24u
#define SMC_ADC1_RES_SGCMP_RES(x)      (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_RES_SGCMP_RES_SHIFT))&SMC_ADC1_RES_SGCMP_RES_MASK)
/* ADC1_RES Reg Mask */
#define SMC_ADC1_RES_MASK              0xC0FFFFFFu
...
/* ADC_PD0_CFG Bit Fields */
#define SMC_ADC_PD0_CFG_ADC_CLK_SEL0_MASK 0x2u
#define SMC_ADC_PD0_CFG_ADC_CLK_SEL0_SHIFT 1u
#define SMC_ADC_PD0_CFG_ADC_CLK_SEL0_WIDTH 1u
#define SMC_ADC_PD0_CFG_ADC_CLK_SEL0(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC_PD0_CFG_ADC_CLK_SEL0_SHIFT))&SMC_ADC_PD0_CFG_ADC_CLK_SEL0_MASK)
#define SMC_ADC_PD0_CFG_LOCK_MASK      0x1u
#define SMC_ADC_PD0_CFG_LOCK_SHIFT     0u
#define SMC_ADC_PD0_CFG_LOCK_WIDTH     1u
#define SMC_ADC_PD0_CFG_LOCK(x)        (((uint32_t)(((uint32_t)(x))<<SMC_ADC_PD0_CFG_LOCK_SHIFT))&SMC_ADC_PD0_CFG_LOCK_MASK)
/* ADC_PD0_CFG Reg Mask */
#define SMC_ADC_PD0_CFG_MASK           0x00000003u

/* TSTMP0_CLK_CFG Bit Fields */
#define SMC_TSTMP0_CLK_CFG_EN_MASK     0x80000000u
#define SMC_TSTMP0_CLK_CFG_EN_SHIFT    31u
#define SMC_TSTMP0_CLK_CFG_EN_WIDTH    1u
#define SMC_TSTMP0_CLK_CFG_EN(x)       (((uint32_t)(((uint32_t)(x))<<SMC_TSTMP0_CLK_CFG_EN_SHIFT))&SMC_TSTMP0_CLK_CFG_EN_MASK)
...
#define SMC_TSTMP0_CLK_CFG_DIV(x)      (((uint32_t)(((uint32_t)(x))<<SMC_TSTMP0_CLK_CFG_DIV_SHIFT))&SMC_TSTMP0_CLK_CFG_DIV_MASK)
...
#define SMC_TSTMP0_CLK_CFG_SEL(x)      (((uint32_t)(((uint32_t)(x))<<SMC_TSTMP0_CLK_CFG_SEL_SHIFT))&SMC_TSTMP0_CLK_CFG_SEL_MASK)
#define SMC_TSTMP0_CLK_CFG_LOCK_MASK   0x1u
#define SMC_TSTMP0_CLK_CFG_LOCK_SHIFT  0u
#define SMC_TSTMP0_CLK_CFG_LOCK_WIDTH  1u
#define SMC_TSTMP0_CLK_CFG_LOCK(x)     (((uint32_t)(((uint32_t)(x))<<SMC_TSTMP0_CLK_CFG_LOCK_SHIFT))&SMC_TSTMP0_CLK_CFG_LOCK_MASK)
/* TSTMP0_CLK_CFG Reg Mask */
#define SMC_TSTMP0_CLK_CFG_MASK        0xF3000001u

/* ADC0_CFG3 Bit Fields */
#define SMC_ADC0_CFG3_SGCMP_TR_SEL1_MASK 0xFFFFFFu
#define SMC_ADC0_CFG3_SGCMP_TR_SEL1_SHIFT 0u
#define SMC_ADC0_CFG3_SGCMP_TR_SEL1_WIDTH 24u
#define SMC_ADC0_CFG3_SGCMP_TR_SEL1(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC0_CFG3_SGCMP_TR_SEL1_SHIFT))&SMC_ADC0_CFG3_SGCMP_TR_SEL1_MASK)
/* ADC0_CFG3 Reg Mask */
#define SMC_ADC0_CFG3_MASK             0x00FFFFFFu

/* ADC1_CFG2 Bit Fields */
#define SMC_ADC1_CFG2_SGCMP_TR_SEL0_MASK 0xFFFFFFu
#define SMC_ADC1_CFG2_SGCMP_TR_SEL0_SHIFT 0u
#define SMC_ADC1_CFG2_SGCMP_TR_SEL0_WIDTH 24u
#define SMC_ADC1_CFG2_SGCMP_TR_SEL0(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG2_SGCMP_TR_SEL0_SHIFT))&SMC_ADC1_CFG2_SGCMP_TR_SEL0_MASK)
/* ADC1_CFG2 Reg Mask */
#define SMC_ADC1_CFG2_MASK             0x00FFFFFFu

/* ADC1_CFG3 Bit Fields */
#define SMC_ADC1_CFG3_SGCMP_TR_SEL1_MASK 0xFFFFFFu
#define SMC_ADC1_CFG3_SGCMP_TR_SEL1_SHIFT 0u
#define SMC_ADC1_CFG3_SGCMP_TR_SEL1_WIDTH 24u
#define SMC_ADC1_CFG3_SGCMP_TR_SEL1(x) (((uint32_t)(((uint32_t)(x))<<SMC_ADC1_CFG3_SGCMP_TR_SEL1_SHIFT))&SMC_ADC1_CFG3_SGCMP_TR_SEL1_MASK)
/* ADC1_CFG3 Reg Mask */
#define SMC_ADC1_CFG3_MASK             0x00FFFFFFu

#ifndef _MODULE_ERM_gmbhdijq97_REGS_H_ERM_H_
#define _MODULE_ERM_gmbhdijq97_REGS_H_ERM_H_
...
#define ERM_EAR_REG_COUNT 33U

typedef struct {

  __IO uint32_t CR[4u]                        ; /* Configuration Register 0, offset: 0x0 */
                                                /* Configuration Register 1, offset: 0x4 */
                                                /* Configuration Register 2, offset: 0x8 */
                                                /* Configuration Register 3, offset: 0xC */
  __IO uint32_t SR[4u]                        ; /* Status Register 0, offset: 0x10 */
                                                /* Status Register 1, offset: 0x14 */
                                                /* Status Register 2, offset: 0x18 */
                                                /* Status Register 3, offset: 0x1C */
  __IO uint32_t CR4                           ; /* Configuration Register 4, offset: 0x20 */
       uint8_t  RESERVED_0[12];
  __IO uint32_t SR4                           ; /* Status Register 4, offset: 0x30 */
...
/* CR4 Bit Fields */
#define ERM_CR4_ESCIE32_MASK           0x80000000u
#define ERM_CR4_ESCIE32_SHIFT          31u
#define ERM_CR4_ESCIE32_WIDTH          1u
#define ERM_CR4_ESCIE32(x)             (((uint32_t)(((uint32_t)(x))<<ERM_CR4_ESCIE32_SHIFT))&ERM_CR4_ESCIE32_MASK)
#define ERM_CR4_ENCIE32_MASK           0x40000000u
#define ERM_CR4_ENCIE32_SHIFT          30u
#define ERM_CR4_ENCIE32_WIDTH          1u
#define ERM_CR4_ENCIE32(x)             (((uint32_t)(((uint32_t)(x))<<ERM_CR4_ENCIE32_SHIFT))&ERM_CR4_ENCIE32_MASK)
/* CR4 Reg Mask */
#define ERM_CR4_MASK                   0xC0000000u

/* SR4 Bit Fields */
#define ERM_SR4_SBC32_MASK             0x80000000u
#define ERM_SR4_SBC32_SHIFT            31u
#define ERM_SR4_SBC32_WIDTH            1u
#define ERM_SR4_SBC32(x)               (((uint32_t)(((uint32_t)(x))<<ERM_SR4_SBC32_SHIFT))&ERM_SR4_SBC32_MASK)
#define ERM_SR4_NCE32_MASK             0x40000000u
#define ERM_SR4_NCE32_SHIFT            30u
#define ERM_SR4_NCE32_WIDTH            1u
#define ERM_SR4_NCE32(x)               (((uint32_t)(((uint32_t)(x))<<ERM_SR4_NCE32_SHIFT))&ERM_SR4_NCE32_MASK)
/* SR4 Reg Mask */
#define ERM_SR4_MASK                   0xC0000000u

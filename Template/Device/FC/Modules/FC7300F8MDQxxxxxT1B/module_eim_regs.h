#ifndef _MODULE_EIM_gmbhdijq80_REGS_H_EIM_H_
#define _MODULE_EIM_gmbhdijq80_REGS_H_EIM_H_
...
/* CPU2_LOCKSTEP Bit Fields */
#define EIM_CPU2_LOCKSTEP_DWP_LOCK_MASK 0x80000000u
#define EIM_CPU2_LOCKSTEP_DWP_LOCK_SHIFT 31u
#define EIM_CPU2_LOCKSTEP_DWP_LOCK_WIDTH 1u
#define EIM_CPU2_LOCKSTEP_DWP_LOCK(x)  (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_DWP_LOCK_SHIFT))&EIM_CPU2_LOCKSTEP_DWP_LOCK_MASK)
#define EIM_CPU2_LOCKSTEP_DWP_MASK     0x70000000u
#define EIM_CPU2_LOCKSTEP_DWP_SHIFT    28u
#define EIM_CPU2_LOCKSTEP_DWP_WIDTH    3u
#define EIM_CPU2_LOCKSTEP_DWP(x)       (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_DWP_SHIFT))&EIM_CPU2_LOCKSTEP_DWP_MASK)
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET_MASK 0x8u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET_SHIFT 3u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET_WIDTH 1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET(x) (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET_SHIFT))&EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_SET_MASK)
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET_MASK 0x4u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET_SHIFT 2u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET_WIDTH 1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET(x) (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET_SHIFT))&EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_SET_MASK)
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR_MASK 0x2u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR_SHIFT 1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR_WIDTH 1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR(x) (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR_SHIFT))&EIM_CPU2_LOCKSTEP_LOCKSTEP_MON0_CLR_MASK)
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR_MASK 0x1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR_SHIFT 0u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR_WIDTH 1u
#define EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR(x) (((uint32_t)(((uint32_t)(x))<<EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR_SHIFT))&EIM_CPU2_LOCKSTEP_LOCKSTEP_MON1_CLR_MASK)
/* CPU2_LOCKSTEP Reg Mask */
#define EIM_CPU2_LOCKSTEP_MASK         0xF000000Fu

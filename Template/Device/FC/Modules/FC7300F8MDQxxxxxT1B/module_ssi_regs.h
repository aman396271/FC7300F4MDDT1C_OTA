#ifndef _MODULE_SSI_gmbhdijq121_REGS_H_SSI_H_
#define _MODULE_SSI_gmbhdijq121_REGS_H_SSI_H_
...
#define SSI_GCR_FUNC_DIV(x)            (((uint32_t)(((uint32_t)(x))<<SSI_GCR_FUNC_DIV_SHIFT))&SSI_GCR_FUNC_DIV_MASK)
#define SSI_GCR_FUNC_EN_MASK           0x1u
#define SSI_GCR_FUNC_EN_SHIFT          0u
#define SSI_GCR_FUNC_EN_WIDTH          1u
#define SSI_GCR_FUNC_EN(x)             (((uint32_t)(((uint32_t)(x))<<SSI_GCR_FUNC_EN_SHIFT))&SSI_GCR_FUNC_EN_MASK)
/* GCR Reg Mask */
...
#define SSI_GSR_PROTOC_ERR(x)          (((uint32_t)(((uint32_t)(x))<<SSI_GSR_PROTOC_ERR_SHIFT))&SSI_GSR_PROTOC_ERR_MASK)
...
#define SSI_GSR_PULSE_WIDTH_ERR(x)     (((uint32_t)(((uint32_t)(x))<<SSI_GSR_PULSE_WIDTH_ERR_SHIFT))&SSI_GSR_PULSE_WIDTH_ERR_MASK)
#define SSI_GSR_INTERVAL_ERR_MASK      0xF00000u
#define SSI_GSR_INTERVAL_ERR_SHIFT     20u
#define SSI_GSR_INTERVAL_ERR_WIDTH     4u
#define SSI_GSR_INTERVAL_ERR(x)        (((uint32_t)(((uint32_t)(x))<<SSI_GSR_INTERVAL_ERR_SHIFT))&SSI_GSR_INTERVAL_ERR_MASK)
#define SSI_GSR_DECODE_ERR_MASK        0xF0000u
#define SSI_GSR_DECODE_ERR_SHIFT       16u
#define SSI_GSR_DECODE_ERR_WIDTH       4u
#define SSI_GSR_DECODE_ERR(x)          (((uint32_t)(((uint32_t)(x))<<SSI_GSR_DECODE_ERR_SHIFT))&SSI_GSR_DECODE_ERR_MASK)
#define SSI_GSR_SPC_RANGE_ERR_MASK     0xF000u
#define SSI_GSR_SPC_RANGE_ERR_SHIFT    12u
#define SSI_GSR_SPC_RANGE_ERR_WIDTH    4u
#define SSI_GSR_SPC_RANGE_ERR(x)       (((uint32_t)(((uint32_t)(x))<<SSI_GSR_SPC_RANGE_ERR_SHIFT))&SSI_GSR_SPC_RANGE_ERR_MASK)
#define SSI_GSR_SPC_TIMEOUT_MASK       0xF00u
#define SSI_GSR_SPC_TIMEOUT_SHIFT      8u
#define SSI_GSR_SPC_TIMEOUT_WIDTH      4u
#define SSI_GSR_SPC_TIMEOUT(x)         (((uint32_t)(((uint32_t)(x))<<SSI_GSR_SPC_TIMEOUT_SHIFT))&SSI_GSR_SPC_TIMEOUT_MASK)
#define SSI_GSR_WHL_STOP_MASK          0xF0u
#define SSI_GSR_WHL_STOP_SHIFT         4u
#define SSI_GSR_WHL_STOP_WIDTH         4u
#define SSI_GSR_WHL_STOP(x)            (((uint32_t)(((uint32_t)(x))<<SSI_GSR_WHL_STOP_SHIFT))&SSI_GSR_WHL_STOP_MASK)
#define SSI_GSR_SPC_VLD_MASK           0xFu
#define SSI_GSR_SPC_VLD_SHIFT          0u
#define SSI_GSR_SPC_VLD_WIDTH          4u
#define SSI_GSR_SPC_VLD(x)             (((uint32_t)(((uint32_t)(x))<<SSI_GSR_SPC_VLD_SHIFT))&SSI_GSR_SPC_VLD_MASK)
/* GSR Reg Mask */
...
#define SSI_GCWLR_WIN_L(x)             (((uint32_t)(((uint32_t)(x))<<SSI_GCWLR_WIN_L_SHIFT))&SSI_GCWLR_WIN_L_MASK)
/* GCWLR Reg Mask */
...
#define SSI_GCWHR_WIN_H(x)             (((uint32_t)(((uint32_t)(x))<<SSI_GCWHR_WIN_H_SHIFT))&SSI_GCWHR_WIN_H_MASK)
/* GCWHR Reg Mask */
...
#define SSI_GPCR_AK_IETH(x)            (((uint32_t)(((uint32_t)(x))<<SSI_GPCR_AK_IETH_SHIFT))&SSI_GPCR_AK_IETH_MASK)
#define SSI_GPCR_AK_PETH_MASK          0x4000u
#define SSI_GPCR_AK_PETH_SHIFT         14u
#define SSI_GPCR_AK_PETH_WIDTH         1u
#define SSI_GPCR_AK_PETH(x)            (((uint32_t)(((uint32_t)(x))<<SSI_GPCR_AK_PETH_SHIFT))&SSI_GPCR_AK_PETH_MASK)
#define SSI_GPCR_PWM_PETH_MASK         0x2000u
#define SSI_GPCR_PWM_PETH_SHIFT        13u
#define SSI_GPCR_PWM_PETH_WIDTH        1u
#define SSI_GPCR_PWM_PETH(x)           (((uint32_t)(((uint32_t)(x))<<SSI_GPCR_PWM_PETH_SHIFT))&SSI_GPCR_PWM_PETH_MASK)
#define SSI_GPCR_REF_WIDTH_MASK        0xFFu
#define SSI_GPCR_REF_WIDTH_SHIFT       0u
#define SSI_GPCR_REF_WIDTH_WIDTH       8u
#define SSI_GPCR_REF_WIDTH(x)          (((uint32_t)(((uint32_t)(x))<<SSI_GPCR_REF_WIDTH_SHIFT))&SSI_GPCR_REF_WIDTH_MASK)
/* GPCR Reg Mask */
...
#define SSI_ICR_GPWM_TOC(x)            (((uint32_t)(((uint32_t)(x))<<SSI_ICR_GPWM_TOC_SHIFT))&SSI_ICR_GPWM_TOC_MASK)
#define SSI_ICR_GPWM_INV_MASK          0x1000u
#define SSI_ICR_GPWM_INV_SHIFT         12u
#define SSI_ICR_GPWM_INV_WIDTH         1u
#define SSI_ICR_GPWM_INV(x)            (((uint32_t)(((uint32_t)(x))<<SSI_ICR_GPWM_INV_SHIFT))&SSI_ICR_GPWM_INV_MASK)
#define SSI_ICR_RES_SEL_MASK           0x200u
#define SSI_ICR_RES_SEL_SHIFT          9u
#define SSI_ICR_RES_SEL_WIDTH          1u
#define SSI_ICR_RES_SEL(x)             (((uint32_t)(((uint32_t)(x))<<SSI_ICR_RES_SEL_SHIFT))&SSI_ICR_RES_SEL_MASK)
#define SSI_ICR_CMP_EN_MASK            0x100u
#define SSI_ICR_CMP_EN_SHIFT           8u
#define SSI_ICR_CMP_EN_WIDTH           1u
#define SSI_ICR_CMP_EN(x)              (((uint32_t)(((uint32_t)(x))<<SSI_ICR_CMP_EN_SHIFT))&SSI_ICR_CMP_EN_MASK)
#define SSI_ICR_PROT_SEL_MASK          0xC0u
#define SSI_ICR_PROT_SEL_SHIFT         6u
#define SSI_ICR_PROT_SEL_WIDTH         2u
#define SSI_ICR_PROT_SEL(x)            (((uint32_t)(((uint32_t)(x))<<SSI_ICR_PROT_SEL_SHIFT))&SSI_ICR_PROT_SEL_MASK)
#define SSI_ICR_CHL_SEL_MASK           0x30u
#define SSI_ICR_CHL_SEL_SHIFT          4u
#define SSI_ICR_CHL_SEL_WIDTH          2u
#define SSI_ICR_CHL_SEL(x)             (((uint32_t)(((uint32_t)(x))<<SSI_ICR_CHL_SEL_SHIFT))&SSI_ICR_CHL_SEL_MASK)
#define SSI_ICR_RANG_CHK_EN_MASK       0x4u
#define SSI_ICR_RANG_CHK_EN_SHIFT      2u
#define SSI_ICR_RANG_CHK_EN_WIDTH      1u
#define SSI_ICR_RANG_CHK_EN(x)         (((uint32_t)(((uint32_t)(x))<<SSI_ICR_RANG_CHK_EN_SHIFT))&SSI_ICR_RANG_CHK_EN_MASK)
#define SSI_ICR_CHL_SW_MASK            0x2u
#define SSI_ICR_CHL_SW_SHIFT           1u
#define SSI_ICR_CHL_SW_WIDTH           1u
#define SSI_ICR_CHL_SW(x)              (((uint32_t)(((uint32_t)(x))<<SSI_ICR_CHL_SW_SHIFT))&SSI_ICR_CHL_SW_MASK)
#define SSI_ICR_SSI_EN_MASK            0x1u
#define SSI_ICR_SSI_EN_SHIFT           0u
#define SSI_ICR_SSI_EN_WIDTH           1u
#define SSI_ICR_SSI_EN(x)              (((uint32_t)(((uint32_t)(x))<<SSI_ICR_SSI_EN_SHIFT))&SSI_ICR_SSI_EN_MASK)
/* ICR0 Reg Mask */
...
#define SSI_IFR_FLT_WIDTH(x)           (((uint32_t)(((uint32_t)(x))<<SSI_IFR_FLT_WIDTH_SHIFT))&SSI_IFR_FLT_WIDTH_MASK)
#define SSI_IFR_FLT_EN_MASK            0x1u
#define SSI_IFR_FLT_EN_SHIFT           0u
#define SSI_IFR_FLT_EN_WIDTH           1u
#define SSI_IFR_FLT_EN(x)              (((uint32_t)(((uint32_t)(x))<<SSI_IFR_FLT_EN_SHIFT))&SSI_IFR_FLT_EN_MASK)
/* IFR0 Reg Mask */
...
#define SSI_INTCR_PROTOC_ERR_INT_EN(x) (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_PROTOC_ERR_INT_EN_SHIFT))&SSI_INTCR_PROTOC_ERR_INT_EN_MASK)
...
#define SSI_INTCR_PULSE_WIDTH_ERR_EN(x) (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_PULSE_WIDTH_ERR_EN_SHIFT))&SSI_INTCR_PULSE_WIDTH_ERR_EN_MASK)
...
#define SSI_INTCR_INTERVAL_ERR_EN(x)   (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_INTERVAL_ERR_EN_SHIFT))&SSI_INTCR_INTERVAL_ERR_EN_MASK)
#define SSI_INTCR_DECODE_ERR_EN_MASK   0x10u
#define SSI_INTCR_DECODE_ERR_EN_SHIFT  4u
#define SSI_INTCR_DECODE_ERR_EN_WIDTH  1u
#define SSI_INTCR_DECODE_ERR_EN(x)     (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_DECODE_ERR_EN_SHIFT))&SSI_INTCR_DECODE_ERR_EN_MASK)
#define SSI_INTCR_RANGE_ERR_EN_MASK    0x8u
#define SSI_INTCR_RANGE_ERR_EN_SHIFT   3u
#define SSI_INTCR_RANGE_ERR_EN_WIDTH   1u
#define SSI_INTCR_RANGE_ERR_EN(x)      (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_RANGE_ERR_EN_SHIFT))&SSI_INTCR_RANGE_ERR_EN_MASK)
...
#define SSI_INTCR_TIMEOUT_INT_EN(x)    (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_TIMEOUT_INT_EN_SHIFT))&SSI_INTCR_TIMEOUT_INT_EN_MASK)
#define SSI_INTCR_STOP_INT_EN_MASK     0x2u
#define SSI_INTCR_STOP_INT_EN_SHIFT    1u
#define SSI_INTCR_STOP_INT_EN_WIDTH    1u
#define SSI_INTCR_STOP_INT_EN(x)       (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_STOP_INT_EN_SHIFT))&SSI_INTCR_STOP_INT_EN_MASK)
#define SSI_INTCR_VLD_INT_EN_MASK      0x1u
#define SSI_INTCR_VLD_INT_EN_SHIFT     0u
#define SSI_INTCR_VLD_INT_EN_WIDTH     1u
#define SSI_INTCR_VLD_INT_EN(x)        (((uint32_t)(((uint32_t)(x))<<SSI_INTCR_VLD_INT_EN_SHIFT))&SSI_INTCR_VLD_INT_EN_MASK)
/* INTCR0 Reg Mask */
...
#define SSI_HPCR_HPULSE(x)             (((uint32_t)(((uint32_t)(x))<<SSI_HPCR_HPULSE_SHIFT))&SSI_HPCR_HPULSE_MASK)
/* HPCR0 Reg Mask */
...
#define SSI_AKPR_MCODE_CNT(x)          (((uint32_t)(((uint32_t)(x))<<SSI_AKPR_MCODE_CNT_SHIFT))&SSI_AKPR_MCODE_CNT_MASK)
#define SSI_AKPR_MCODE_MASK            0x1FFu
#define SSI_AKPR_MCODE_SHIFT           0u
#define SSI_AKPR_MCODE_WIDTH           9u
#define SSI_AKPR_MCODE(x)              (((uint32_t)(((uint32_t)(x))<<SSI_AKPR_MCODE_SHIFT))&SSI_AKPR_MCODE_MASK)
/* AKPR0 Reg Mask */
...
#define SSI_PWMPR_PCODE(x)             (((uint32_t)(((uint32_t)(x))<<SSI_PWMPR_PCODE_SHIFT))&SSI_PWMPR_PCODE_MASK)
/* PWMPR0 Reg Mask */
...
#define SSI_ISR_PROTOC_ERR(x)          (((uint32_t)(((uint32_t)(x))<<SSI_ISR_PROTOC_ERR_SHIFT))&SSI_ISR_PROTOC_ERR_MASK)
...
#define SSI_ISR_PULSE_WIDTH_ERR(x)     (((uint32_t)(((uint32_t)(x))<<SSI_ISR_PULSE_WIDTH_ERR_SHIFT))&SSI_ISR_PULSE_WIDTH_ERR_MASK)
#define SSI_ISR_INTERVAL_ERR_MASK      0x200u
#define SSI_ISR_INTERVAL_ERR_SHIFT     9u
#define SSI_ISR_INTERVAL_ERR_WIDTH     1u
#define SSI_ISR_INTERVAL_ERR(x)        (((uint32_t)(((uint32_t)(x))<<SSI_ISR_INTERVAL_ERR_SHIFT))&SSI_ISR_INTERVAL_ERR_MASK)
#define SSI_ISR_DECODE_ERR_MASK        0x100u
#define SSI_ISR_DECODE_ERR_SHIFT       8u
#define SSI_ISR_DECODE_ERR_WIDTH       1u
#define SSI_ISR_DECODE_ERR(x)          (((uint32_t)(((uint32_t)(x))<<SSI_ISR_DECODE_ERR_SHIFT))&SSI_ISR_DECODE_ERR_MASK)
#define SSI_ISR_SPC_RANGE_ERR_MASK     0x20u
#define SSI_ISR_SPC_RANGE_ERR_SHIFT    5u
#define SSI_ISR_SPC_RANGE_ERR_WIDTH    1u
#define SSI_ISR_SPC_RANGE_ERR(x)       (((uint32_t)(((uint32_t)(x))<<SSI_ISR_SPC_RANGE_ERR_SHIFT))&SSI_ISR_SPC_RANGE_ERR_MASK)
#define SSI_ISR_SPC_TIMEOUT_ERR_MASK   0x10u
#define SSI_ISR_SPC_TIMEOUT_ERR_SHIFT  4u
#define SSI_ISR_SPC_TIMEOUT_ERR_WIDTH  1u
#define SSI_ISR_SPC_TIMEOUT_ERR(x)     (((uint32_t)(((uint32_t)(x))<<SSI_ISR_SPC_TIMEOUT_ERR_SHIFT))&SSI_ISR_SPC_TIMEOUT_ERR_MASK)
#define SSI_ISR_CMP_IOK_MASK           0x4u
#define SSI_ISR_CMP_IOK_SHIFT          2u
#define SSI_ISR_CMP_IOK_WIDTH          1u
#define SSI_ISR_CMP_IOK(x)             (((uint32_t)(((uint32_t)(x))<<SSI_ISR_CMP_IOK_SHIFT))&SSI_ISR_CMP_IOK_MASK)
#define SSI_ISR_WHL_STOP_MASK          0x2u
#define SSI_ISR_WHL_STOP_SHIFT         1u
#define SSI_ISR_WHL_STOP_WIDTH         1u
#define SSI_ISR_WHL_STOP(x)            (((uint32_t)(((uint32_t)(x))<<SSI_ISR_WHL_STOP_SHIFT))&SSI_ISR_WHL_STOP_MASK)
#define SSI_ISR_SPC_VLD_MASK           0x1u
#define SSI_ISR_SPC_VLD_SHIFT          0u
#define SSI_ISR_SPC_VLD_WIDTH          1u
#define SSI_ISR_SPC_VLD(x)             (((uint32_t)(((uint32_t)(x))<<SSI_ISR_SPC_VLD_SHIFT))&SSI_ISR_SPC_VLD_MASK)
/* ISR0 Reg Mask */
...
#define SSI_TCR_BIST_LOCK_KEY(x)       (((uint32_t)(((uint32_t)(x))<<SSI_TCR_BIST_LOCK_KEY_SHIFT))&SSI_TCR_BIST_LOCK_KEY_MASK)
#define SSI_TCR_CMP_BISTEN_MASK        0x4u
#define SSI_TCR_CMP_BISTEN_SHIFT       2u
#define SSI_TCR_CMP_BISTEN_WIDTH       1u
#define SSI_TCR_CMP_BISTEN(x)          (((uint32_t)(((uint32_t)(x))<<SSI_TCR_CMP_BISTEN_SHIFT))&SSI_TCR_CMP_BISTEN_MASK)
#define SSI_TCR_DUALCMP_OUT28_MASK     0x2u
#define SSI_TCR_DUALCMP_OUT28_SHIFT    1u
#define SSI_TCR_DUALCMP_OUT28_WIDTH    1u
#define SSI_TCR_DUALCMP_OUT28(x)       (((uint32_t)(((uint32_t)(x))<<SSI_TCR_DUALCMP_OUT28_SHIFT))&SSI_TCR_DUALCMP_OUT28_MASK)
#define SSI_TCR_DUALCMP_OUT14_MASK     0x1u
#define SSI_TCR_DUALCMP_OUT14_SHIFT    0u
#define SSI_TCR_DUALCMP_OUT14_WIDTH    1u
#define SSI_TCR_DUALCMP_OUT14(x)       (((uint32_t)(((uint32_t)(x))<<SSI_TCR_DUALCMP_OUT14_SHIFT))&SSI_TCR_DUALCMP_OUT14_MASK)
/* TCR0 Reg Mask */

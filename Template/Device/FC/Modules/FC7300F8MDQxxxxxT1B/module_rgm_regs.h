#ifndef _MODULE_RGM_gmbhdijq119_REGS_H_RGM_H_
#define _MODULE_RGM_gmbhdijq119_REGS_H_RGM_H_
...
typedef struct {
  ...
  __IO uint32_t C2_CFG                        ; /* CPU2 Reset Configuration Register, offset: 0x300 */
  __IO uint32_t C2_RST                        ; /* CPU2 Reset Register, offset: 0x304 */
  __IO uint32_t C2_SRS                        ; /* CPU2 System Reset Status Register, offset: 0x308 */
  __IO uint32_t C2_RLS                        ; /* CPU2 Release Register, offset: 0x30C */
  __IO uint32_t C2_RIC                        ; /* CPU2 Reset Interrupt Control Register, offset: 0x310 */
  __IO uint32_t C2_SSRS                       ; /* CPU2 Sticky System Reset Status Register, offset: 0x314 */
       uint8_t  RESERVED_6[232];
  __IO uint32_t C3_CFG                        ; /* CPU3 Reset Configuration Register, offset: 0x400 */
  __IO uint32_t C3_RST                        ; /* CPU3 Reset Register, offset: 0x404 */
  __IO uint32_t C3_SRS                        ; /* CPU3 System Reset Status Register, offset: 0x408 */
  __IO uint32_t C3_RLS                        ; /* CPU3 Release Register, offset: 0x40C */
  __IO uint32_t C3_RIC                        ; /* CPU3 Reset Interrupt Control Register, offset: 0x410 */
  __IO uint32_t C3_SSRS                       ; /* CPU3 Sticky System Reset Status Register, offset: 0x414 */
...
#define RGM_C1_RIC_C1_RIC_TOC23_MASK   0x2u
#define RGM_C1_RIC_C1_RIC_TOC23_SHIFT  1u
#define RGM_C1_RIC_C1_RIC_TOC23_WIDTH  1u
#define RGM_C1_RIC_C1_RIC_TOC23(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C1_RIC_C1_RIC_TOC23_SHIFT))&RGM_C1_RIC_C1_RIC_TOC23_MASK)
...
/* C1_RIC Reg Mask */
#define RGM_C1_RIC_MASK                0x00000007u
...
/* C2_CFG Bit Fields */
#define RGM_C2_CFG_WPB_LOCK_MASK       0x80000000u
#define RGM_C2_CFG_WPB_LOCK_SHIFT      31u
#define RGM_C2_CFG_WPB_LOCK_WIDTH      1u
#define RGM_C2_CFG_WPB_LOCK(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_WPB_LOCK_SHIFT))&RGM_C2_CFG_WPB_LOCK_MASK)
...
#define RGM_C2_CFG_C2_SWRST_EN_MASK    0x100000u
#define RGM_C2_CFG_C2_SWRST_EN_SHIFT   20u
#define RGM_C2_CFG_C2_SWRST_EN_WIDTH   1u
#define RGM_C2_CFG_C2_SWRST_EN(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_SWRST_EN_SHIFT))&RGM_C2_CFG_C2_SWRST_EN_MASK)
#define RGM_C2_CFG_C2_INTM_EN_MASK     0x80000u
#define RGM_C2_CFG_C2_INTM_EN_SHIFT    19u
#define RGM_C2_CFG_C2_INTM_EN_WIDTH    1u
#define RGM_C2_CFG_C2_INTM_EN(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_INTM_EN_SHIFT))&RGM_C2_CFG_C2_INTM_EN_MASK)
#define RGM_C2_CFG_C2_WDOG_EN_MASK     0x40000u
#define RGM_C2_CFG_C2_WDOG_EN_SHIFT    18u
#define RGM_C2_CFG_C2_WDOG_EN_WIDTH    1u
#define RGM_C2_CFG_C2_WDOG_EN(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_WDOG_EN_SHIFT))&RGM_C2_CFG_C2_WDOG_EN_MASK)
#define RGM_C2_CFG_C2_SYSRST_EN_MASK   0x20000u
#define RGM_C2_CFG_C2_SYSRST_EN_SHIFT  17u
#define RGM_C2_CFG_C2_SYSRST_EN_WIDTH  1u
#define RGM_C2_CFG_C2_SYSRST_EN(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_SYSRST_EN_SHIFT))&RGM_C2_CFG_C2_SYSRST_EN_MASK)
#define RGM_C2_CFG_C2_LOCKUP_EN_MASK   0x10000u
#define RGM_C2_CFG_C2_LOCKUP_EN_SHIFT  16u
#define RGM_C2_CFG_C2_LOCKUP_EN_WIDTH  1u
#define RGM_C2_CFG_C2_LOCKUP_EN(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_LOCKUP_EN_SHIFT))&RGM_C2_CFG_C2_LOCKUP_EN_MASK)
#define RGM_C2_CFG_C2_SWRST_IE_MASK    0x10u
#define RGM_C2_CFG_C2_SWRST_IE_SHIFT   4u
#define RGM_C2_CFG_C2_SWRST_IE_WIDTH   1u
#define RGM_C2_CFG_C2_SWRST_IE(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_SWRST_IE_SHIFT))&RGM_C2_CFG_C2_SWRST_IE_MASK)
#define RGM_C2_CFG_C2_INTM_IE_MASK     0x8u
#define RGM_C2_CFG_C2_INTM_IE_SHIFT    3u
#define RGM_C2_CFG_C2_INTM_IE_WIDTH    1u
#define RGM_C2_CFG_C2_INTM_IE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_INTM_IE_SHIFT))&RGM_C2_CFG_C2_INTM_IE_MASK)
#define RGM_C2_CFG_C2_WDOG_IE_MASK     0x4u
#define RGM_C2_CFG_C2_WDOG_IE_SHIFT    2u
#define RGM_C2_CFG_C2_WDOG_IE_WIDTH    1u
#define RGM_C2_CFG_C2_WDOG_IE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_WDOG_IE_SHIFT))&RGM_C2_CFG_C2_WDOG_IE_MASK)
#define RGM_C2_CFG_C2_SYSRST_IE_MASK   0x2u
#define RGM_C2_CFG_C2_SYSRST_IE_SHIFT  1u
#define RGM_C2_CFG_C2_SYSRST_IE_WIDTH  1u
#define RGM_C2_CFG_C2_SYSRST_IE(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_SYSRST_IE_SHIFT))&RGM_C2_CFG_C2_SYSRST_IE_MASK)
#define RGM_C2_CFG_C2_LOCKUP_IE_MASK   0x1u
#define RGM_C2_CFG_C2_LOCKUP_IE_SHIFT  0u
#define RGM_C2_CFG_C2_LOCKUP_IE_WIDTH  1u
#define RGM_C2_CFG_C2_LOCKUP_IE(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_CFG_C2_LOCKUP_IE_SHIFT))&RGM_C2_CFG_C2_LOCKUP_IE_MASK)
/* C2_CFG Reg Mask */
#define RGM_C2_CFG_MASK                0xF01F001Fu
...
#define RGM_C2_RST_C2_OUT_OF_RST(x)    (((uint32_t)(((uint32_t)(x))<<RGM_C2_RST_C2_OUT_OF_RST_SHIFT))&RGM_C2_RST_C2_OUT_OF_RST_MASK)
#define RGM_C2_RST_C2_SWRST_MASK       0x1u
#define RGM_C2_RST_C2_SWRST_SHIFT      0u
#define RGM_C2_RST_C2_SWRST_WIDTH      1u
#define RGM_C2_RST_C2_SWRST(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_RST_C2_SWRST_SHIFT))&RGM_C2_RST_C2_SWRST_MASK)
/* C2_RST Reg Mask */
#define RGM_C2_RST_MASK                0x00000003u

/* C2_SRS Bit Fields */
#define RGM_C2_SRS_SYSRST_TOUT_MASK    0x80000000u
#define RGM_C2_SRS_SYSRST_TOUT_SHIFT   31u
#define RGM_C2_SRS_SYSRST_TOUT_WIDTH   1u
#define RGM_C2_SRS_SYSRST_TOUT(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_SYSRST_TOUT_SHIFT))&RGM_C2_SRS_SYSRST_TOUT_MASK)
#define RGM_C2_SRS_PINRST_TOUT_MASK    0x40000000u
#define RGM_C2_SRS_PINRST_TOUT_SHIFT   30u
#define RGM_C2_SRS_PINRST_TOUT_WIDTH   1u
#define RGM_C2_SRS_PINRST_TOUT(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_PINRST_TOUT_SHIFT))&RGM_C2_SRS_PINRST_TOUT_MASK)
#define RGM_C2_SRS_FSM_ERR_MASK        0x20000000u
#define RGM_C2_SRS_FSM_ERR_SHIFT       29u
#define RGM_C2_SRS_FSM_ERR_WIDTH       1u
#define RGM_C2_SRS_FSM_ERR(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_FSM_ERR_SHIFT))&RGM_C2_SRS_FSM_ERR_MASK)
#define RGM_C2_SRS_C2_SWRST_MASK       0x100000u
#define RGM_C2_SRS_C2_SWRST_SHIFT      20u
#define RGM_C2_SRS_C2_SWRST_WIDTH      1u
#define RGM_C2_SRS_C2_SWRST(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_SWRST_SHIFT))&RGM_C2_SRS_C2_SWRST_MASK)
#define RGM_C2_SRS_C2_INTM_MASK        0x80000u
#define RGM_C2_SRS_C2_INTM_SHIFT       19u
#define RGM_C2_SRS_C2_INTM_WIDTH       1u
#define RGM_C2_SRS_C2_INTM(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_INTM_SHIFT))&RGM_C2_SRS_C2_INTM_MASK)
#define RGM_C2_SRS_C2_WDOG_MASK        0x40000u
#define RGM_C2_SRS_C2_WDOG_SHIFT       18u
#define RGM_C2_SRS_C2_WDOG_WIDTH       1u
#define RGM_C2_SRS_C2_WDOG(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_WDOG_SHIFT))&RGM_C2_SRS_C2_WDOG_MASK)
#define RGM_C2_SRS_C2_SYSRST_MASK      0x20000u
#define RGM_C2_SRS_C2_SYSRST_SHIFT     17u
#define RGM_C2_SRS_C2_SYSRST_WIDTH     1u
#define RGM_C2_SRS_C2_SYSRST(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_SYSRST_SHIFT))&RGM_C2_SRS_C2_SYSRST_MASK)
#define RGM_C2_SRS_C2_LOCKUP_MASK      0x10000u
#define RGM_C2_SRS_C2_LOCKUP_SHIFT     16u
#define RGM_C2_SRS_C2_LOCKUP_WIDTH     1u
#define RGM_C2_SRS_C2_LOCKUP(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_LOCKUP_SHIFT))&RGM_C2_SRS_C2_LOCKUP_MASK)
#define RGM_C2_SRS_C2_SRS_MASK         0xFFFFu
#define RGM_C2_SRS_C2_SRS_SHIFT        0u
#define RGM_C2_SRS_C2_SRS_WIDTH        16u
#define RGM_C2_SRS_C2_SRS(x)           (((uint32_t)(((uint32_t)(x))<<RGM_C2_SRS_C2_SRS_SHIFT))&RGM_C2_SRS_C2_SRS_MASK)
/* C2_SRS Reg Mask */
#define RGM_C2_SRS_MASK                0xE01FFFFFu

/* C2_RLS Bit Fields */
#define RGM_C2_RLS_C2_RELEASE_MASK     0x1u
#define RGM_C2_RLS_C2_RELEASE_SHIFT    0u
#define RGM_C2_RLS_C2_RELEASE_WIDTH    1u
#define RGM_C2_RLS_C2_RELEASE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_RLS_C2_RELEASE_SHIFT))&RGM_C2_RLS_C2_RELEASE_MASK)
/* C2_RLS Reg Mask */
#define RGM_C2_RLS_MASK                0x00000001u

/* C2_RIC Bit Fields */
#define RGM_C2_RIC_C2_RIC_RST_MASK     0x4u
#define RGM_C2_RIC_C2_RIC_RST_SHIFT    2u
#define RGM_C2_RIC_C2_RIC_RST_WIDTH    1u
#define RGM_C2_RIC_C2_RIC_RST(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_RIC_C2_RIC_RST_SHIFT))&RGM_C2_RIC_C2_RIC_RST_MASK)
#define RGM_C2_RIC_C2_RIC_TOC13_MASK   0x2u
#define RGM_C2_RIC_C2_RIC_TOC13_SHIFT  1u
#define RGM_C2_RIC_C2_RIC_TOC13_WIDTH  1u
#define RGM_C2_RIC_C2_RIC_TOC13(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_RIC_C2_RIC_TOC13_SHIFT))&RGM_C2_RIC_C2_RIC_TOC13_MASK)
#define RGM_C2_RIC_C2_RIC_TOC0_MASK    0x1u
#define RGM_C2_RIC_C2_RIC_TOC0_SHIFT   0u
#define RGM_C2_RIC_C2_RIC_TOC0_WIDTH   1u
#define RGM_C2_RIC_C2_RIC_TOC0(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C2_RIC_C2_RIC_TOC0_SHIFT))&RGM_C2_RIC_C2_RIC_TOC0_MASK)
/* C2_RIC Reg Mask */
#define RGM_C2_RIC_MASK                0x00000007u

/* C2_SSRS Bit Fields */
#define RGM_C2_SSRS_SYSRST_TOUT_MASK   0x80000000u
#define RGM_C2_SSRS_SYSRST_TOUT_SHIFT  31u
#define RGM_C2_SSRS_SYSRST_TOUT_WIDTH  1u
#define RGM_C2_SSRS_SYSRST_TOUT(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_SYSRST_TOUT_SHIFT))&RGM_C2_SSRS_SYSRST_TOUT_MASK)
#define RGM_C2_SSRS_PINRST_TOUT_MASK   0x40000000u
#define RGM_C2_SSRS_PINRST_TOUT_SHIFT  30u
#define RGM_C2_SSRS_PINRST_TOUT_WIDTH  1u
#define RGM_C2_SSRS_PINRST_TOUT(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_PINRST_TOUT_SHIFT))&RGM_C2_SSRS_PINRST_TOUT_MASK)
#define RGM_C2_SSRS_FSM_ERR_MASK       0x20000000u
#define RGM_C2_SSRS_FSM_ERR_SHIFT      29u
#define RGM_C2_SSRS_FSM_ERR_WIDTH      1u
#define RGM_C2_SSRS_FSM_ERR(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_FSM_ERR_SHIFT))&RGM_C2_SSRS_FSM_ERR_MASK)
#define RGM_C2_SSRS_C2_SWRST_MASK      0x100000u
#define RGM_C2_SSRS_C2_SWRST_SHIFT     20u
#define RGM_C2_SSRS_C2_SWRST_WIDTH     1u
#define RGM_C2_SSRS_C2_SWRST(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_C2_SWRST_SHIFT))&RGM_C2_SSRS_C2_SWRST_MASK)
#define RGM_C2_SSRS_C2_INTM_MASK       0x80000u
#define RGM_C2_SSRS_C2_INTM_SHIFT      19u
#define RGM_C2_SSRS_C2_INTM_WIDTH      1u
#define RGM_C2_SSRS_C2_INTM(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_C2_INTM_SHIFT))&RGM_C2_SSRS_C2_INTM_MASK)
#define RGM_C2_SSRS_C2_WDOG_MASK       0x40000u
#define RGM_C2_SSRS_C2_WDOG_SHIFT      18u
#define RGM_C2_SSRS_C2_WDOG_WIDTH      1u
#define RGM_C2_SSRS_C2_WDOG(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_C2_WDOG_SHIFT))&RGM_C2_SSRS_C2_WDOG_MASK)
#define RGM_C2_SSRS_C2_SYSRST_MASK     0x20000u
#define RGM_C2_SSRS_C2_SYSRST_SHIFT    17u
#define RGM_C2_SSRS_C2_SYSRST_WIDTH    1u
#define RGM_C2_SSRS_C2_SYSRST(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_C2_SYSRST_SHIFT))&RGM_C2_SSRS_C2_SYSRST_MASK)
#define RGM_C2_SSRS_C2_LOCKUP_MASK     0x10000u
#define RGM_C2_SSRS_C2_LOCKUP_SHIFT    16u
#define RGM_C2_SSRS_C2_LOCKUP_WIDTH    1u
#define RGM_C2_SSRS_C2_LOCKUP(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_C2_LOCKUP_SHIFT))&RGM_C2_SSRS_C2_LOCKUP_MASK)
#define RGM_C2_SSRS_SSRS_MASK          0xFFFFu
#define RGM_C2_SSRS_SSRS_SHIFT         0u
#define RGM_C2_SSRS_SSRS_WIDTH         16u
#define RGM_C2_SSRS_SSRS(x)            (((uint32_t)(((uint32_t)(x))<<RGM_C2_SSRS_SSRS_SHIFT))&RGM_C2_SSRS_SSRS_MASK)
/* C2_SSRS Reg Mask */
#define RGM_C2_SSRS_MASK               0xE01FFFFFu

/* C3_CFG Bit Fields */
#define RGM_C3_CFG_WPB_LOCK_MASK       0x80000000u
#define RGM_C3_CFG_WPB_LOCK_SHIFT      31u
#define RGM_C3_CFG_WPB_LOCK_WIDTH      1u
#define RGM_C3_CFG_WPB_LOCK(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_WPB_LOCK_SHIFT))&RGM_C3_CFG_WPB_LOCK_MASK)
#define RGM_C3_CFG_WPB_MASK            0x70000000u
#define RGM_C3_CFG_WPB_SHIFT           28u
#define RGM_C3_CFG_WPB_WIDTH           3u
#define RGM_C3_CFG_WPB(x)              (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_WPB_SHIFT))&RGM_C3_CFG_WPB_MASK)
#define RGM_C3_CFG_C3_SWRST_EN_MASK    0x100000u
#define RGM_C3_CFG_C3_SWRST_EN_SHIFT   20u
#define RGM_C3_CFG_C3_SWRST_EN_WIDTH   1u
#define RGM_C3_CFG_C3_SWRST_EN(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_SWRST_EN_SHIFT))&RGM_C3_CFG_C3_SWRST_EN_MASK)
#define RGM_C3_CFG_C3_INTM_EN_MASK     0x80000u
#define RGM_C3_CFG_C3_INTM_EN_SHIFT    19u
#define RGM_C3_CFG_C3_INTM_EN_WIDTH    1u
#define RGM_C3_CFG_C3_INTM_EN(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_INTM_EN_SHIFT))&RGM_C3_CFG_C3_INTM_EN_MASK)
#define RGM_C3_CFG_C3_WDOG_EN_MASK     0x40000u
#define RGM_C3_CFG_C3_WDOG_EN_SHIFT    18u
#define RGM_C3_CFG_C3_WDOG_EN_WIDTH    1u
#define RGM_C3_CFG_C3_WDOG_EN(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_WDOG_EN_SHIFT))&RGM_C3_CFG_C3_WDOG_EN_MASK)
#define RGM_C3_CFG_C3_SYSRST_EN_MASK   0x20000u
#define RGM_C3_CFG_C3_SYSRST_EN_SHIFT  17u
#define RGM_C3_CFG_C3_SYSRST_EN_WIDTH  1u
#define RGM_C3_CFG_C3_SYSRST_EN(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_SYSRST_EN_SHIFT))&RGM_C3_CFG_C3_SYSRST_EN_MASK)
#define RGM_C3_CFG_C3_LOCKUP_EN_MASK   0x10000u
#define RGM_C3_CFG_C3_LOCKUP_EN_SHIFT  16u
#define RGM_C3_CFG_C3_LOCKUP_EN_WIDTH  1u
#define RGM_C3_CFG_C3_LOCKUP_EN(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_LOCKUP_EN_SHIFT))&RGM_C3_CFG_C3_LOCKUP_EN_MASK)
#define RGM_C3_CFG_C3_SWRST_IE_MASK    0x10u
#define RGM_C3_CFG_C3_SWRST_IE_SHIFT   4u
#define RGM_C3_CFG_C3_SWRST_IE_WIDTH   1u
#define RGM_C3_CFG_C3_SWRST_IE(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_SWRST_IE_SHIFT))&RGM_C3_CFG_C3_SWRST_IE_MASK)
#define RGM_C3_CFG_C3_INTM_IE_MASK     0x8u
#define RGM_C3_CFG_C3_INTM_IE_SHIFT    3u
#define RGM_C3_CFG_C3_INTM_IE_WIDTH    1u
#define RGM_C3_CFG_C3_INTM_IE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_INTM_IE_SHIFT))&RGM_C3_CFG_C3_INTM_IE_MASK)
#define RGM_C3_CFG_C3_WDOG_IE_MASK     0x4u
#define RGM_C3_CFG_C3_WDOG_IE_SHIFT    2u
#define RGM_C3_CFG_C3_WDOG_IE_WIDTH    1u
#define RGM_C3_CFG_C3_WDOG_IE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_WDOG_IE_SHIFT))&RGM_C3_CFG_C3_WDOG_IE_MASK)
#define RGM_C3_CFG_C3_SYSRST_IE_MASK   0x2u
#define RGM_C3_CFG_C3_SYSRST_IE_SHIFT  1u
#define RGM_C3_CFG_C3_SYSRST_IE_WIDTH  1u
#define RGM_C3_CFG_C3_SYSRST_IE(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_SYSRST_IE_SHIFT))&RGM_C3_CFG_C3_SYSRST_IE_MASK)
#define RGM_C3_CFG_C3_LOCKUP_IE_MASK   0x1u
#define RGM_C3_CFG_C3_LOCKUP_IE_SHIFT  0u
#define RGM_C3_CFG_C3_LOCKUP_IE_WIDTH  1u
#define RGM_C3_CFG_C3_LOCKUP_IE(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_CFG_C3_LOCKUP_IE_SHIFT))&RGM_C3_CFG_C3_LOCKUP_IE_MASK)
/* C3_CFG Reg Mask */
#define RGM_C3_CFG_MASK                0xF01F001Fu

/* C3_RST Bit Fields */
#define RGM_C3_RST_C3_OUT_OF_RST_MASK  0x2u
#define RGM_C3_RST_C3_OUT_OF_RST_SHIFT 1u
#define RGM_C3_RST_C3_OUT_OF_RST_WIDTH 1u
#define RGM_C3_RST_C3_OUT_OF_RST(x)    (((uint32_t)(((uint32_t)(x))<<RGM_C3_RST_C3_OUT_OF_RST_SHIFT))&RGM_C3_RST_C3_OUT_OF_RST_MASK)
#define RGM_C3_RST_C3_SWRST_MASK       0x1u
#define RGM_C3_RST_C3_SWRST_SHIFT      0u
#define RGM_C3_RST_C3_SWRST_WIDTH      1u
#define RGM_C3_RST_C3_SWRST(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_RST_C3_SWRST_SHIFT))&RGM_C3_RST_C3_SWRST_MASK)
/* C3_RST Reg Mask */
#define RGM_C3_RST_MASK                0x00000003u

/* C3_SRS Bit Fields */
#define RGM_C3_SRS_SYSRST_TOUT_MASK    0x80000000u
#define RGM_C3_SRS_SYSRST_TOUT_SHIFT   31u
#define RGM_C3_SRS_SYSRST_TOUT_WIDTH   1u
#define RGM_C3_SRS_SYSRST_TOUT(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_SYSRST_TOUT_SHIFT))&RGM_C3_SRS_SYSRST_TOUT_MASK)
#define RGM_C3_SRS_PINRST_TOUT_MASK    0x40000000u
#define RGM_C3_SRS_PINRST_TOUT_SHIFT   30u
#define RGM_C3_SRS_PINRST_TOUT_WIDTH   1u
#define RGM_C3_SRS_PINRST_TOUT(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_PINRST_TOUT_SHIFT))&RGM_C3_SRS_PINRST_TOUT_MASK)
#define RGM_C3_SRS_FSM_ERR_MASK        0x20000000u
#define RGM_C3_SRS_FSM_ERR_SHIFT       29u
#define RGM_C3_SRS_FSM_ERR_WIDTH       1u
#define RGM_C3_SRS_FSM_ERR(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_FSM_ERR_SHIFT))&RGM_C3_SRS_FSM_ERR_MASK)
#define RGM_C3_SRS_C3_SWRST_MASK       0x100000u
#define RGM_C3_SRS_C3_SWRST_SHIFT      20u
#define RGM_C3_SRS_C3_SWRST_WIDTH      1u
#define RGM_C3_SRS_C3_SWRST(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_SWRST_SHIFT))&RGM_C3_SRS_C3_SWRST_MASK)
#define RGM_C3_SRS_C3_INTM_MASK        0x80000u
#define RGM_C3_SRS_C3_INTM_SHIFT       19u
#define RGM_C3_SRS_C3_INTM_WIDTH       1u
#define RGM_C3_SRS_C3_INTM(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_INTM_SHIFT))&RGM_C3_SRS_C3_INTM_MASK)
#define RGM_C3_SRS_C3_WDOG_MASK        0x40000u
#define RGM_C3_SRS_C3_WDOG_SHIFT       18u
#define RGM_C3_SRS_C3_WDOG_WIDTH       1u
#define RGM_C3_SRS_C3_WDOG(x)          (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_WDOG_SHIFT))&RGM_C3_SRS_C3_WDOG_MASK)
#define RGM_C3_SRS_C3_SYSRST_MASK      0x20000u
#define RGM_C3_SRS_C3_SYSRST_SHIFT     17u
#define RGM_C3_SRS_C3_SYSRST_WIDTH     1u
#define RGM_C3_SRS_C3_SYSRST(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_SYSRST_SHIFT))&RGM_C3_SRS_C3_SYSRST_MASK)
#define RGM_C3_SRS_C3_LOCKUP_MASK      0x10000u
#define RGM_C3_SRS_C3_LOCKUP_SHIFT     16u
#define RGM_C3_SRS_C3_LOCKUP_WIDTH     1u
#define RGM_C3_SRS_C3_LOCKUP(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_LOCKUP_SHIFT))&RGM_C3_SRS_C3_LOCKUP_MASK)
#define RGM_C3_SRS_C3_SRS_MASK         0xFFFFu
#define RGM_C3_SRS_C3_SRS_SHIFT        0u
#define RGM_C3_SRS_C3_SRS_WIDTH        16u
#define RGM_C3_SRS_C3_SRS(x)           (((uint32_t)(((uint32_t)(x))<<RGM_C3_SRS_C3_SRS_SHIFT))&RGM_C3_SRS_C3_SRS_MASK)
/* C3_SRS Reg Mask */
#define RGM_C3_SRS_MASK                0xE01FFFFFu

/* C3_RLS Bit Fields */
#define RGM_C3_RLS_C3_RELEASE_MASK     0x1u
#define RGM_C3_RLS_C3_RELEASE_SHIFT    0u
#define RGM_C3_RLS_C3_RELEASE_WIDTH    1u
#define RGM_C3_RLS_C3_RELEASE(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_RLS_C3_RELEASE_SHIFT))&RGM_C3_RLS_C3_RELEASE_MASK)
/* C3_RLS Reg Mask */
#define RGM_C3_RLS_MASK                0x00000001u

/* C3_RIC Bit Fields */
#define RGM_C3_RIC_C3_RIC_RST_MASK     0x4u
#define RGM_C3_RIC_C3_RIC_RST_SHIFT    2u
#define RGM_C3_RIC_C3_RIC_RST_WIDTH    1u
#define RGM_C3_RIC_C3_RIC_RST(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_RIC_C3_RIC_RST_SHIFT))&RGM_C3_RIC_C3_RIC_RST_MASK)
#define RGM_C3_RIC_C3_RIC_TOC12_MASK   0x2u
#define RGM_C3_RIC_C3_RIC_TOC12_SHIFT  1u
#define RGM_C3_RIC_C3_RIC_TOC12_WIDTH  1u
#define RGM_C3_RIC_C3_RIC_TOC12(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_RIC_C3_RIC_TOC12_SHIFT))&RGM_C3_RIC_C3_RIC_TOC12_MASK)
#define RGM_C3_RIC_C3_RIC_TOC0_MASK    0x1u
#define RGM_C3_RIC_C3_RIC_TOC0_SHIFT   0u
#define RGM_C3_RIC_C3_RIC_TOC0_WIDTH   1u
#define RGM_C3_RIC_C3_RIC_TOC0(x)      (((uint32_t)(((uint32_t)(x))<<RGM_C3_RIC_C3_RIC_TOC0_SHIFT))&RGM_C3_RIC_C3_RIC_TOC0_MASK)
/* C3_RIC Reg Mask */
#define RGM_C3_RIC_MASK                0x00000007u

/* C3_SSRS Bit Fields */
#define RGM_C3_SSRS_SYSRST_TOUT_MASK   0x80000000u
#define RGM_C3_SSRS_SYSRST_TOUT_SHIFT  31u
#define RGM_C3_SSRS_SYSRST_TOUT_WIDTH  1u
#define RGM_C3_SSRS_SYSRST_TOUT(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_SYSRST_TOUT_SHIFT))&RGM_C3_SSRS_SYSRST_TOUT_MASK)
#define RGM_C3_SSRS_PINRST_TOUT_MASK   0x40000000u
#define RGM_C3_SSRS_PINRST_TOUT_SHIFT  30u
#define RGM_C3_SSRS_PINRST_TOUT_WIDTH  1u
#define RGM_C3_SSRS_PINRST_TOUT(x)     (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_PINRST_TOUT_SHIFT))&RGM_C3_SSRS_PINRST_TOUT_MASK)
#define RGM_C3_SSRS_FSM_ERR_MASK       0x20000000u
#define RGM_C3_SSRS_FSM_ERR_SHIFT      29u
#define RGM_C3_SSRS_FSM_ERR_WIDTH      1u
#define RGM_C3_SSRS_FSM_ERR(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_FSM_ERR_SHIFT))&RGM_C3_SSRS_FSM_ERR_MASK)
#define RGM_C3_SSRS_C3_SWRST_MASK      0x100000u
#define RGM_C3_SSRS_C3_SWRST_SHIFT     20u
#define RGM_C3_SSRS_C3_SWRST_WIDTH     1u
#define RGM_C3_SSRS_C3_SWRST(x)        (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_C3_SWRST_SHIFT))&RGM_C3_SSRS_C3_SWRST_MASK)
#define RGM_C3_SSRS_C3_INTM_MASK       0x80000u
#define RGM_C3_SSRS_C3_INTM_SHIFT      19u
#define RGM_C3_SSRS_C3_INTM_WIDTH      1u
#define RGM_C3_SSRS_C3_INTM(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_C3_INTM_SHIFT))&RGM_C3_SSRS_C3_INTM_MASK)
#define RGM_C3_SSRS_C3_WDOG_MASK       0x40000u
#define RGM_C3_SSRS_C3_WDOG_SHIFT      18u
#define RGM_C3_SSRS_C3_WDOG_WIDTH      1u
#define RGM_C3_SSRS_C3_WDOG(x)         (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_C3_WDOG_SHIFT))&RGM_C3_SSRS_C3_WDOG_MASK)
#define RGM_C3_SSRS_C3_SYSRST_MASK     0x20000u
#define RGM_C3_SSRS_C3_SYSRST_SHIFT    17u
#define RGM_C3_SSRS_C3_SYSRST_WIDTH    1u
#define RGM_C3_SSRS_C3_SYSRST(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_C3_SYSRST_SHIFT))&RGM_C3_SSRS_C3_SYSRST_MASK)
#define RGM_C3_SSRS_C3_LOCKUP_MASK     0x10000u
#define RGM_C3_SSRS_C3_LOCKUP_SHIFT    16u
#define RGM_C3_SSRS_C3_LOCKUP_WIDTH    1u
#define RGM_C3_SSRS_C3_LOCKUP(x)       (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_C3_LOCKUP_SHIFT))&RGM_C3_SSRS_C3_LOCKUP_MASK)
#define RGM_C3_SSRS_SSRS_MASK          0xFFFFu
#define RGM_C3_SSRS_SSRS_SHIFT         0u
#define RGM_C3_SSRS_SSRS_WIDTH         16u
#define RGM_C3_SSRS_SSRS(x)            (((uint32_t)(((uint32_t)(x))<<RGM_C3_SSRS_SSRS_SHIFT))&RGM_C3_SSRS_SSRS_MASK)
/* C3_SSRS Reg Mask */
#define RGM_C3_SSRS_MASK               0xE01FFFFFu

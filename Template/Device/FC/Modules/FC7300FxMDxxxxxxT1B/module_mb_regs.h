#ifndef _MODULE_MB_gmbhdijq235_REGS_H_MB_H_
#define _MODULE_MB_gmbhdijq235_REGS_H_MB_H_
...
#define MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3_MASK 0x8u
#define MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3_SHIFT 3u
#define MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3_WIDTH 1u
#define MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3(x) (((uint32_t)(((uint32_t)(x))<<MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3_SHIFT))&MB_CCn_SEMA_UNLK_AUTO_CLEAR_EN3_MASK)
...
#define MB_CCn_SEMA_UNLK_MASK          0x0000000Fu

/* CCn_REQUEST Bit Fields */
#define MB_CCn_REQUEST_REQ3_MASK       0x8u
#define MB_CCn_REQUEST_REQ3_SHIFT      3u
#define MB_CCn_REQUEST_REQ3_WIDTH      1u
#define MB_CCn_REQUEST_REQ3(x)         (((uint32_t)(((uint32_t)(x))<<MB_CCn_REQUEST_REQ3_SHIFT))&MB_CCn_REQUEST_REQ3_MASK)
...
#define MB_CCn_REQUEST_MASK            0x0000000Fu

/* CCn_DONE Bit Fields */
#define MB_CCn_DONE_DONE3_MASK         0x8u
#define MB_CCn_DONE_DONE3_SHIFT        3u
#define MB_CCn_DONE_DONE3_WIDTH        1u
#define MB_CCn_DONE_DONE3(x)           (((uint32_t)(((uint32_t)(x))<<MB_CCn_DONE_DONE3_SHIFT))&MB_CCn_DONE_DONE3_MASK)
...
/* CC0_DONE Reg Mask */
#define MB_CCn_DONE_MASK               0x0000000Fu
...
#define MB_CCn_DONE_MASK_DONE_MASK3_MASK 0x8u
#define MB_CCn_DONE_MASK_DONE_MASK3_SHIFT 3u
#define MB_CCn_DONE_MASK_DONE_MASK3_WIDTH 1u
#define MB_CCn_DONE_MASK_DONE_MASK3(x) (((uint32_t)(((uint32_t)(x))<<MB_CCn_DONE_MASK_DONE_MASK3_SHIFT))&MB_CCn_DONE_MASK_DONE_MASK3_MASK)
...
#define MB_CCn_DONE_MASK_MASK          0x000F000Fu
...
#define MB_INTn_FLG_MASK_REQ_FLAG_MASK_MASK 0xFFFFu
#define MB_INTn_FLG_MASK_REQ_FLAG_MASK_SHIFT 0u
#define MB_INTn_FLG_MASK_REQ_FLAG_MASK_WIDTH 16u
...
#define MB_INTn_FLG_MASK_MASK          0xFFFFFFFFu

/* INTn_INTEN Bit Fields */
#define MB_INTn_INTEN_DONE_INT_EN_MASK 0xFFFF0000u
#define MB_INTn_INTEN_DONE_INT_EN_SHIFT 16u
#define MB_INTn_INTEN_DONE_INT_EN_WIDTH 16u
#define MB_INTn_INTEN_DONE_INT_EN(x)   (((uint32_t)(((uint32_t)(x))<<MB_INTn_INTEN_DONE_INT_EN_SHIFT))&MB_INTn_INTEN_DONE_INT_EN_MASK)
#define MB_INTn_INTEN_REQ_INT_EN_MASK  0xFFFFu
#define MB_INTn_INTEN_REQ_INT_EN_SHIFT 0u
#define MB_INTn_INTEN_REQ_INT_EN_WIDTH 16u
#define MB_INTn_INTEN_REQ_INT_EN(x)    (((uint32_t)(((uint32_t)(x))<<MB_INTn_INTEN_REQ_INT_EN_SHIFT))&MB_INTn_INTEN_REQ_INT_EN_MASK)
/* INT0_INTEN Reg Mask */
#define MB_INTn_INTEN_MASK             0xFFFFFFFFu

/* INTn_FLG_STAT Bit Fields */
#define MB_INTn_FLG_STAT_FLG_INT_STAT_MASK 0xFFFFFFFFu
#define MB_INTn_FLG_STAT_FLG_INT_STAT_SHIFT 0u
#define MB_INTn_FLG_STAT_FLG_INT_STAT_WIDTH 32u
#define MB_INTn_FLG_STAT_FLG_INT_STAT(x) (((uint32_t)(((uint32_t)(x))<<MB_INTn_FLG_STAT_FLG_INT_STAT_SHIFT))&MB_INTn_FLG_STAT_FLG_INT_STAT_MASK)
/* INT0_FLG_STAT Reg Mask */
#define MB_INTn_FLG_STAT_MASK          0xFFFFFFFFu

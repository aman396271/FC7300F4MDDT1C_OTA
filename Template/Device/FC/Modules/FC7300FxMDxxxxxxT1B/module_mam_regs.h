#ifndef _MODULE_MAM_gmbhdijq267_REGS_H_MAM_H_
#define _MODULE_MAM_gmbhdijq267_REGS_H_MAM_H_
...
/** Peripheral MAM2 base address */
#define MAM2_BASE                                (0x4040f000u)
/** Peripheral MAM2 base pointer */
#define MAM2                                     ((MAM_Type *)MAM2_BASE)
...
//#define MAM_IRQS                                 {MAM0_IRQn, MAM1_IRQn, MAM2_IRQn}
...
#define MAM_MAXCFG_SOFTRESET_MASK      0x1u
#define MAM_MAXCFG_SOFTRESET_SHIFT     0u
#define MAM_MAXCFG_SOFTRESET_WIDTH     1u
#define MAM_MAXCFG_SOFTRESET(x)        (((uint32_t)(((uint32_t)(x))<<MAM_MAXCFG_SOFTRESET_SHIFT))&MAM_MAXCFG_SOFTRESET_MASK)
/* MAXCFG Reg Mask */
#define MAM_MAXCFG_MASK                0xFF00FF01u

/* BSTCR Bit Fields */
#define MAM_BSTCR_INCRBREAK6_MASK      0x3000u
#define MAM_BSTCR_INCRBREAK6_SHIFT     12u
#define MAM_BSTCR_INCRBREAK6_WIDTH     2u
#define MAM_BSTCR_INCRBREAK6(x)        (((uint32_t)(((uint32_t)(x))<<MAM_BSTCR_INCRBREAK6_SHIFT))&MAM_BSTCR_INCRBREAK6_MASK)
#define MAM_BSTCR_INCRBREAK5_MASK      0xC00u
#define MAM_BSTCR_INCRBREAK5_SHIFT     10u
#define MAM_BSTCR_INCRBREAK5_WIDTH     2u
#define MAM_BSTCR_INCRBREAK5(x)        (((uint32_t)(((uint32_t)(x))<<MAM_BSTCR_INCRBREAK5_SHIFT))&MAM_BSTCR_INCRBREAK5_MASK)
...
/* BSTCR Reg Mask */
#define MAM_BSTCR_MASK                 0x00003FFFu

/* WDGCR Bit Fields */
#define MAM_WDGCR_WDOGSTATUS6_MASK     0x400000u
#define MAM_WDGCR_WDOGSTATUS6_SHIFT    22u
#define MAM_WDGCR_WDOGSTATUS6_WIDTH    1u
#define MAM_WDGCR_WDOGSTATUS6(x)       (((uint32_t)(((uint32_t)(x))<<MAM_WDGCR_WDOGSTATUS6_SHIFT))&MAM_WDGCR_WDOGSTATUS6_MASK)
#define MAM_WDGCR_WDOGSTATUS5_MASK     0x200000u
#define MAM_WDGCR_WDOGSTATUS5_SHIFT    21u
#define MAM_WDGCR_WDOGSTATUS5_WIDTH    1u
#define MAM_WDGCR_WDOGSTATUS5(x)       (((uint32_t)(((uint32_t)(x))<<MAM_WDGCR_WDOGSTATUS5_SHIFT))&MAM_WDGCR_WDOGSTATUS5_MASK)
...
#define MAM_WDGCR_WDOGCTRL6_MASK       0x40u
#define MAM_WDGCR_WDOGCTRL6_SHIFT      6u
#define MAM_WDGCR_WDOGCTRL6_WIDTH      1u
#define MAM_WDGCR_WDOGCTRL6(x)         (((uint32_t)(((uint32_t)(x))<<MAM_WDGCR_WDOGCTRL6_SHIFT))&MAM_WDGCR_WDOGCTRL6_MASK)
#define MAM_WDGCR_WDOGCTRL5_MASK       0x20u
#define MAM_WDGCR_WDOGCTRL5_SHIFT      5u
#define MAM_WDGCR_WDOGCTRL5_WIDTH      1u
#define MAM_WDGCR_WDOGCTRL5(x)         (((uint32_t)(((uint32_t)(x))<<MAM_WDGCR_WDOGCTRL5_SHIFT))&MAM_WDGCR_WDOGCTRL5_MASK)
...
/* WDGCR Reg Mask */
#define MAM_WDGCR_MASK                 0x007F007Fu

/* TOCR Bit Fields */
#define MAM_TOCR_TIMEOUTCTRL6_MASK     0x3000u
#define MAM_TOCR_TIMEOUTCTRL6_SHIFT    12u
#define MAM_TOCR_TIMEOUTCTRL6_WIDTH    2u
#define MAM_TOCR_TIMEOUTCTRL6(x)       (((uint32_t)(((uint32_t)(x))<<MAM_TOCR_TIMEOUTCTRL6_SHIFT))&MAM_TOCR_TIMEOUTCTRL6_MASK)
#define MAM_TOCR_TIMEOUTCTRL5_MASK     0xC00u
#define MAM_TOCR_TIMEOUTCTRL5_SHIFT    10u
#define MAM_TOCR_TIMEOUTCTRL5_WIDTH    2u
#define MAM_TOCR_TIMEOUTCTRL5(x)       (((uint32_t)(((uint32_t)(x))<<MAM_TOCR_TIMEOUTCTRL5_SHIFT))&MAM_TOCR_TIMEOUTCTRL5_MASK)
...
/* TOCR Reg Mask */
#define MAM_TOCR_MASK                  0x00003FFFu

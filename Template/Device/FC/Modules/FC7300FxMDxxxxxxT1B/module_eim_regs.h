#ifndef _MODULE_EIM_gmbhdijq246_REGS_H_EIM_H_
#define _MODULE_EIM_gmbhdijq246_REGS_H_EIM_H_
...
#define EIM_CTRL_REG_COUNT 78
#define EIM_BUS_REG_COUNT 4

typedef struct {

  __O  uint32_t CR                            ; /* Configuration Register, offset: 0x0 */
       uint8_t  RESERVED_0[12];
  __IO uint32_t CTRL_REG[EIM_CTRL_REG_COUNT]  ; /* Channel N Control Register, offset: 0x10 */
       uint8_t  RESERVED_1[696];
  __O  uint32_t LOCKSTEP[4u]                  ; /* EIM CPU0 LOCKSTEP Error Injection Register, offset: 0x400 */

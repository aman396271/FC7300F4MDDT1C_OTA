#ifndef _MODULE_CMP_gmbhdijq266_REGS_H_CMP_H_
#define _MODULE_CMP_gmbhdijq266_REGS_H_CMP_H_
...
typedef struct {
  ...
  __IO uint32_t CSCR0                         ; /* Round Robin Control Register 0, offset: 0x24 */
...
/* CSCR0 Bit Fields */
#define CMP_CSCR0_RR_INITMOD_MASK      0x3F0000u
#define CMP_CSCR0_RR_INITMOD_SHIFT     16u
#define CMP_CSCR0_RR_INITMOD_WIDTH     6u
#define CMP_CSCR0_RR_INITMOD(x)        (((uint32_t)(((uint32_t)(x))<<CMP_CSCR0_RR_INITMOD_SHIFT))&CMP_CSCR0_RR_INITMOD_MASK)
#define CMP_CSCR0_RR_NSAM_MASK         0x300u
#define CMP_CSCR0_RR_NSAM_SHIFT        8u
#define CMP_CSCR0_RR_NSAM_WIDTH        2u
#define CMP_CSCR0_RR_NSAM(x)           (((uint32_t)(((uint32_t)(x))<<CMP_CSCR0_RR_NSAM_SHIFT))&CMP_CSCR0_RR_NSAM_MASK)
#define CMP_CSCR0_RR_EN_MASK           0x1u
#define CMP_CSCR0_RR_EN_SHIFT          0u
#define CMP_CSCR0_RR_EN_WIDTH          1u
#define CMP_CSCR0_RR_EN(x)             (((uint32_t)(((uint32_t)(x))<<CMP_CSCR0_RR_EN_SHIFT))&CMP_CSCR0_RR_EN_MASK)
/* CSCR0 Reg Mask */

#ifndef _MODULE_SCG_gmbhdijq281_REGS_H_SCG_H_
#define _MODULE_SCG_gmbhdijq281_REGS_H_SCG_H_
...
typedef struct {
  ...
  __IO uint32_t CFG                           ; /* Configuration Register, offset: 0x8 */
       uint8 RESERVED_1[4];
  ...
  __IO uint32_t PLL1SCFG                      ; /* PLL1 Special Configuration Register, offset: 0x5FC */
  ...
  __IO uint32_t PLL0SCFG                      ; /* PLL0 Special Configuration Register, offset: 0x6FC */
...
#define SCG_CFG_PORT_LOCK_KEY(x)       (((uint32_t)(((uint32_t)(x)) << SCG_CFG_PORT_LOCK_KEY_SHIFT)) & SCG_CFG_PORT_LOCK_KEY_MASK)
#define SCG_CFG_PORT_CFG_EN_MASK       0x1u
#define SCG_CFG_PORT_CFG_EN_SHIFT      0u
#define SCG_CFG_PORT_CFG_EN_WIDTH      1u
#define SCG_CFG_PORT_CFG_EN(x)         (((uint32_t)(((uint32_t)(x)) << SCG_CFG_PORT_CFG_EN_SHIFT)) & SCG_CFG_PORT_CFG_EN_MASK)
...
#define SCG_PLL0SCFG_FS_EN(x)          (((uint32_t)(((uint32_t)(x)) << SCG_PLL0SCFG_FS_EN_SHIFT)) & SCG_PLL0SCFG_FS_EN_MASK)

/* PLL1SCFG Bit Fields */
#define SCG_PLL1SCFG_FS_EN_MASK        0x1u
#define SCG_PLL1SCFG_FS_EN_SHIFT       0u
#define SCG_PLL1SCFG_FS_EN_WIDTH       1u
#define SCG_PLL1SCFG_FS_EN(x)          (((uint32_t)(((uint32_t)(x)) << SCG_PLL1SCFG_FS_EN_SHIFT)) & SCG_PLL1SCFG_FS_EN_MASK)

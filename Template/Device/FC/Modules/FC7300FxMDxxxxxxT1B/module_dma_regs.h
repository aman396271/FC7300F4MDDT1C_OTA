#ifndef _MODULE_DMA_gmbhdijq275_REGS_H_DMA_H_
#define _MODULE_DMA_gmbhdijq275_REGS_H_DMA_H_
...
typedef struct {
  ...
  __IO uint8_t  CHPRI[32]      ; /* Channel n Priority Register, array offset: 0x100, array step: 0x1 */

#ifndef _MODULE_FCUART_gmbhdijq258_REGS_H_FCUART_H_
#define _MODULE_FCUART_gmbhdijq258_REGS_H_FCUART_H_
...
typedef struct {
  ...
  __IO uint32_t HFCR                          ; /* Hardware Flow Control Register, offset: 0x24 */
...
//#define FCUART_IRQS                              {FCUART0_IRQn, FCUART1_IRQn, FCUART2_IRQn, FCUART3_IRQn, FCUART4_IRQn, FCUART5_IRQn, FCUART6_IRQn, FCUART7_IRQn, FCUART8_IRQn, FCUART9_IRQn, FCUART10_IRQn, FCUART11_IRQn, FCUART12_IRQn, FCUART13_IRQn, FCUART14_IRQn, FCUART15_IRQn, FCUART16_IRQn, FCUART17_IRQn}
...
#define FCUART_CHANGE_MASK             0x3FE00000
...
/* HFCR Bit Fields */
#define FCUART_HFCR_RXRTSCFG_MASK      0x300u
#define FCUART_HFCR_RXRTSCFG_SHIFT     8u
#define FCUART_HFCR_RXRTSCFG_WIDTH     2u
#define FCUART_HFCR_RXRTSCFG(x)        (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_RXRTSCFG_SHIFT))&FCUART_HFCR_RXRTSCFG_MASK)
#define FCUART_HFCR_TXCTSSRC_MASK      0x20u
#define FCUART_HFCR_TXCTSSRC_SHIFT     5u
#define FCUART_HFCR_TXCTSSRC_WIDTH     1u
#define FCUART_HFCR_TXCTSSRC(x)        (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_TXCTSSRC_SHIFT))&FCUART_HFCR_TXCTSSRC_MASK)
#define FCUART_HFCR_TXCTSCFG_MASK      0x10u
#define FCUART_HFCR_TXCTSCFG_SHIFT     4u
#define FCUART_HFCR_TXCTSCFG_WIDTH     1u
#define FCUART_HFCR_TXCTSCFG(x)        (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_TXCTSCFG_SHIFT))&FCUART_HFCR_TXCTSCFG_MASK)
#define FCUART_HFCR_RXRTSEN_MASK       0x8u
#define FCUART_HFCR_RXRTSEN_SHIFT      3u
#define FCUART_HFCR_RXRTSEN_WIDTH      1u
#define FCUART_HFCR_RXRTSEN(x)         (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_RXRTSEN_SHIFT))&FCUART_HFCR_RXRTSEN_MASK)
#define FCUART_HFCR_TXRTSPOL_MASK      0x4u
#define FCUART_HFCR_TXRTSPOL_SHIFT     2u
#define FCUART_HFCR_TXRTSPOL_WIDTH     1u
#define FCUART_HFCR_TXRTSPOL(x)        (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_TXRTSPOL_SHIFT))&FCUART_HFCR_TXRTSPOL_MASK)
#define FCUART_HFCR_TXRTSEN_MASK       0x2u
#define FCUART_HFCR_TXRTSEN_SHIFT      1u
#define FCUART_HFCR_TXRTSEN_WIDTH      1u
#define FCUART_HFCR_TXRTSEN(x)         (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_TXRTSEN_SHIFT))&FCUART_HFCR_TXRTSEN_MASK)
#define FCUART_HFCR_TXCTSEN_MASK       0x1u
#define FCUART_HFCR_TXCTSEN_SHIFT      0u
#define FCUART_HFCR_TXCTSEN_WIDTH      1u
#define FCUART_HFCR_TXCTSEN(x)         (((uint32_t)(((uint32_t)(x))<<FCUART_HFCR_TXCTSEN_SHIFT))&FCUART_HFCR_TXCTSEN_MASK)
/* HFCR Reg Mask */
#define FCUART_HFCR_MASK               0x0000033Fu

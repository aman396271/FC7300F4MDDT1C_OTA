#ifndef _MODULE_DMA_gmbhdijq225_REGS_H_DMA_H_
#define _MODULE_DMA_gmbhdijq225_REGS_H_DMA_H_
...
typedef struct {
  ...
  __IO uint32_t UME[1]                          ; /* Unaligned Modulo Enable Register 0, offset: 0x48 */
       uint8_t  RESERVED_6[4];
  __IO uint32_t UMO[DMA_UMO_COUNT]            ; /* Unaligned Modulo N Offset Register, offset: 0x50 */
       uint8_t  RESERVED_7[160];
  __IO uint8_t  CHPRI[16]                        ; /* Channel Priority Register, offset: 0x100 */
...
/* CR Reg Mask */
#define DMA_CR_MASK                    0x000301F6u

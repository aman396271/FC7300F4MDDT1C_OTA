#ifndef _MODULE_DMAMUX_gmbhdijq203_REGS_H_DMAMUX_H_
#define _MODULE_DMAMUX_gmbhdijq203_REGS_H_DMAMUX_H_
...
typedef struct {
  ...
  __IO uint8_t  CHTRG                         ; /* Channel N Trigger Register, offset: 0x10 */

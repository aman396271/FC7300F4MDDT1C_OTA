#ifndef _DEVICE_FEATURES_FC7240F2MDS2P144T1A_H_
#define _DEVICE_FEATURES_FC7240F2MDS2P144T1A_H_

#include "FC7240F2MDS2xxxxT1A_feature.h"
...
typedef enum
{
PORTA_25_ADC0_SE0_ADC0_DIFF_P0 = 0U,
PORTA_25_GPIO = 1U,
...
typedef enum
{
PORTA_27_ADC0_SE6_ADC0_DIFF_N2 = 0U,
PORTA_27_GPIO = 1U,
...
typedef enum
{
PORTA_28_ADC0_SE7_ADC0_DIFF_N3 = 0U,
PORTA_28_GPIO = 1U,
...
typedef enum
{
PORTD_0_ADC1_SE1_ADC1_DIFF_P1 = 0U,
PORTD_0_GPIO = 1U,
PORTD_0_FTU0_CH2 = 2U,
PORTD_0_FTU2_CH0 = 3U,
...
typedef enum
{
PORTD_1_ADC1_SE5_ADC1_DIFF_N1 = 0U,
PORTD_1_GPIO = 1U,
PORTD_1_FTU0_CH3 = 2U,
PORTD_1_FTU2_CH1 = 3U,
...
typedef enum
{
PORTE_10_ADC1_SE0_ADC1_DIFF_P0 = 0U,
PORTE_10_GPIO = 1U,
...
typedef enum
{
PORTE_11_ADC1_SE4_ADC1_DIFF_N0 = 0U,
PORTE_11_GPIO = 1U,
...
typedef enum
{
PORTE_12_ADC0_SE3_ADC0_DIFF_P3 = 0U,
PORTE_12_GPIO = 1U,
...
typedef enum
{
PORTE_13_ADC0_SE5_ADC0_DIFF_N1 = 0U,
PORTE_13_GPIO = 1U,
...
typedef enum
{
PORTE_15_ADC1_SE2_ADC1_DIFF_P2 = 0U,
PORTE_15_GPIO = 1U,
...
typedef enum
{
PORTE_16_ADC1_SE6_ADC1_DIFF_N2 = 0U,
PORTE_16_GPIO = 1U,
...
typedef enum
{
PORTE_4_ADC0_SE4_ADC0_DIFF_N0 = 0U,
PORTE_4_GPIO = 1U,
PORTE_4_FTU6_CH0 = 2U,
...
typedef enum
{
PORTE_5_ADC0_SE1_ADC0_DIFF_P1 = 0U,
PORTE_5_GPIO = 1U,
PORTE_5_FTU_TCK2 = 2U,
...
#define GPIOA_PIN_MASK     (uint32_t)(0xfe03ffdfu)
/** @brief GpioB Pin MASK structure */
#define GPIOB_PIN_MASK     (uint32_t)(0x3af7fffbu)
/** @brief GpioC Pin MASK structure */
#define GPIOC_PIN_MASK     (uint32_t)(0xf84bffffu)
/** @brief GpioD Pin MASK structure */
#define GPIOD_PIN_MASK     (uint32_t)(0x79cf9fffu)
/** @brief GpioE Pin MASK structure */
#define GPIOE_PIN_MASK     (uint32_t)(0x3f9ffffu)
...
#endif /* _DEVICE_FEATURES_FC7240F2MDS2P144T1A_H_ */

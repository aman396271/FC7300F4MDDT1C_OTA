#ifndef _DEVICE_FEATURES_FC7240F2MDS2_ISM_COMMON_H_
#define _DEVICE_FEATURES_FC7240F2MDS2_ISM_COMMON_H_

#define FPC_INSTANCE_COUNT (16U)
#define LAM_INSTANCE_COUNT (8U)
...
#endif /* _DEVICE_FEATURES_FC7240F2MDS2_ISM_COMMON_H_ */

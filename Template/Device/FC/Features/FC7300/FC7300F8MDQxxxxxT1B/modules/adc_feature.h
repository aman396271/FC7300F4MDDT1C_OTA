#ifndef _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_ADC_COMMON_H_
#define _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_ADC_COMMON_H_

/************ ADC Features **************/

/** Number of instances of the ADC module. */
#define ADC_INSTANCE_COUNT                       (6u)
...
#define ADC_BASE_PTRS                            {ADC0, ADC1, ADC2, ADC3, ADC4, ADC5}
...
#define ADC_SUPPORT_SG_CMP_INSTANCE_START        (1u)
...
#define ADC2_CHANNEL_V11_PD0                     ADC_CHANNEL_INTERNAL_0
#define ADC2_CHANNEL_VREFH0                      ADC_CHANNEL_INTERNAL_1
#define ADC2_CHANNEL_VDDA0                       ADC_CHANNEL_INTERNAL_2
#define ADC2_CHANNEL_CMP0_DAC                    ADC_CHANNEL_INTERNAL_4
#define ADC2_CHANNEL_TEMPSENSOR_OUT              ADC_CHANNEL_INTERNAL_5
...
#define ADC4_CHANNEL_V11_PD1                     ADC_CHANNEL_INTERNAL_0
#define ADC4_CHANNEL_VREFH1                      ADC_CHANNEL_INTERNAL_1
#define ADC4_CHANNEL_VDDA1                       ADC_CHANNEL_INTERNAL_2

#define ADC5_CHANNEL_V11_PD1                     ADC_CHANNEL_INTERNAL_0
#define ADC5_CHANNEL_VREFH1                      ADC_CHANNEL_INTERNAL_1
#define ADC5_CHANNEL_VDDA1                       ADC_CHANNEL_INTERNAL_2

#endif /* _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_ADC_COMMON_H_ */

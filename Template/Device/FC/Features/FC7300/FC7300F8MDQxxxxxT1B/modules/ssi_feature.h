#ifndef _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_SSI_COMMON_H_
#define _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_SSI_COMMON_H_
/** Number of instances of the MAM module. */
#define SSI_INSTANCE_COUNT                       (1u)
#define SSI_INTERNAL_CMP_SUPPORT                 (STD_ON)
...
typedef enum
{
    INTERNAL_CMP = 0x0U, /**< Internal comparator */
...
typedef struct
{
    ...
    uint8_t                u8ResSel;     /* register select for comp intern register*/
    uint8_t                u8CmpEn;      /* intern comparator enable*/
...
#endif /* _DEVICE_FEATURES_FC7300F8MDQxxxxxT1B_SSI_COMMON_H_ */

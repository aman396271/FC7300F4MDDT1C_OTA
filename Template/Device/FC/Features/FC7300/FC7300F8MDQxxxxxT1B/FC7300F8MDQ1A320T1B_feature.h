#ifndef _DEVICE_FEATURES_FC7300F8MDQ1A320T1B_H_
#define _DEVICE_FEATURES_FC7300F8MDQ1A320T1B_H_
...
typedef enum
{
    PORTC_26_ADC2_SE19 = 0U,
    PORTC_26_GPIO = 1U,
    PORTC_26_eFTU1_IN7 = 2U,
    PORTC_26_QDT1_INDEX = 3U,
    PORTC_26_FLEXCAN2_TX = 4U,
    PORTC_26_eFTU2_OUT_S7 = 5U,
    PORTC_26_eFTU1_OUT_S11 = 7U,
} PORT_C26MuxType;

/** @brief PORTC27 Mode enumeration */
typedef enum
{
    PORTC_27_ADC5_SE3_ADC5_DIFF_P3 = 0U,
    PORTC_27_GPIO = 1U,
    PORTC_27_eFTU0_OUT_S28 = 3U,
    PORTC_27_FCSPI2_PCS1 = 4U,
    PORTC_27_QDT3_HOME = 5U,
    PORTC_27_FCUART5_RX = 6U,
    PORTC_27_eFTU1_OUT_S26 = 7U,
} PORT_C27MuxType;
...
typedef enum
{
    PORTF_0_HSADC2_CH3 = 0U,
    PORTF_0_GPIO = 1U,
    PORTF_0_FCUART6_RX = 2U,
    PORTF_0_FTU2_QD_PHA = 3U,
    PORTF_0_SENT0_RXD2 = 4U,
    PORTF_0_eFTU2_IN6 = 5U,
    PORTF_0_eFTU0_OUT_S14 = 7U,
} PORT_F0MuxType;

/** @brief PORTF1 Mode enumeration */
typedef enum
{
    PORTF_1_HSADC2_CH2 = 0U,
    PORTF_1_GPIO = 1U,
    PORTF_1_FCUART6_TX = 2U,
    PORTF_1_FTU2_QD_PHB = 3U,
    PORTF_1_SENT0_RXD3 = 4U,
    PORTF_1_eFTU2_IN7 = 5U,
    PORTF_1_eFTU0_OUT_S15 = 7U,
} PORT_F1MuxType;

/** @brief PORTF10 Mode enumeration */
typedef enum
{
    PORTF_10_ADC4_SE5_ADC4_DIFF_N1 = 0U,
    PORTF_10_GPIO = 1U,
    PORTF_10_FTU0_CH4 = 3U,
    PORTF_10_MSC0_SDI1 = 4U,
    PORTF_10_eFTU0_OUT_S27 = 5U,
    PORTF_10_SDADC1_PWM_N = 6U,
    PORTF_10_TPU0_CH30 = 7U,
} PORT_F10MuxType;
...
typedef enum
{
    ...
    PORTF_18_eFTU0_IN7 = 3U,
    PORTF_18_FCUART1_TX = 4U,
    PORTF_18_MSC1_EN2 = 5U,
    PORTF_18_TPU0_CH3 = 6U,
    PORTF_18_eFTU1_OUT_S0 = 7U,
} PORT_F18MuxType;
...
typedef enum
{
    ...
    PORTF_19_MSC1_SDI2 = 5U,
    PORTF_19_eFTU0_IN0 = 6U,
    PORTF_19_eFTU1_OUT_S1 = 7U,
} PORT_F19MuxType;
...
typedef enum
{
    PORTF_21_HSADC3_CH5 = 0U,
    PORTF_21_GPIO = 1U,
    PORTF_21_FTU3_CH6 = 2U,
    PORTF_21_FCIIC1_SCL = 3U,
    PORTF_21_CMP0_OUT = 4U,
    PORTF_21_RTC_CLKOUT = 5U,
    PORTF_21_eFTU1_IN7 = 6U,
    PORTF_21_eFTU0_OUT_S6 = 7U,
} PORT_F21MuxType;

/** @brief PORTF22 Mode enumeration */
typedef enum
{
    PORTF_22_HSADC3_CH4 = 0U,
    PORTF_22_GPIO = 1U,
    PORTF_22_FTU3_CH7 = 2U,
    PORTF_22_FCIIC1_SDA = 3U,
    PORTF_22_eFTU2_IN0 = 4U,
    PORTF_22_eFTU2_OUT_S15 = 5U,
    PORTF_22_eFTU0_OUT_S7 = 7U,
} PORT_F22MuxType;
...
typedef enum
{
    PORTF_6_ADC0_SE14 = 0U,
    PORTF_6_GPIO = 1U,
    PORTF_6_FCUART11_TX = 2U,
    PORTF_6_FTU6_CH4 = 3U,
    PORTF_6_SSI0_DIG_28_CH1 = 4U,
    PORTF_6_eFTU2_OUT_S17 = 5U,
    PORTF_6_eFTU0_OUT_S17 = 6U,
    PORTF_6_TPU0_CH24 = 7U,
} PORT_F6MuxType;
...
typedef enum
{
    PORTG_12_ADC4_SE3_ADC4_DIFF_P3 = 0U,
    PORTG_12_GPIO = 1U,
    PORTG_12_SDADC0_PWM_N = 2U,
    PORTG_12_FLEXCAN9_RX = 3U,
    PORTG_12_FTU6_CH7 = 4U,
    PORTG_12_SDADC1_EXT_SIGN = 5U,
    PORTG_12_eFTU1_OUT_S30 = 7U,
} PORT_G12MuxType;
...
{
    PORTG_6_GPIO = 1U,
    PORTG_6_TPU0_CH12 = 2U,
    PORTG_6_eFTU0_IN6 = 3U,
    PORTG_6_FCSPI3_SOUT = 4U,
    PORTG_6_HSADC0_IO0 = 5U,
    PORTG_6_TRGSEL_OUT3 = 6U,
    PORTG_6_eFTU1_OUT_S6 = 7U,
} PORT_G6MuxType;
...
{
    PORTG_7_GPIO = 1U,
    PORTG_7_TPU0_CH13 = 2U,
    PORTG_7_eFTU0_IN7 = 3U,
    PORTG_7_FCSPI3_PCS0 = 4U,
    PORTG_7_HSADC0_IO1 = 5U,
    PORTG_7_TRGSEL_OUT2 = 6U,
    PORTG_7_eFTU1_OUT_S7 = 7U,
} PORT_G7MuxType;
...
typedef enum
{
    PORTH_0_HSADC0_CH2 = 0U,
    PORTH_0_GPIO = 1U,
    PORTH_0_FCUART7_RTS = 2U,
    PORTH_0_eFTU1_IN7 = 3U,
    PORTH_0_FLEXCAN4_TX = 4U,
    PORTH_0_eFTU2_OUT_S25 = 5U,
} PORT_H0MuxType;

/** @brief PORTH1 Mode enumeration */
typedef enum
{
    PORTH_1_HSADC0_CH3 = 0U,
    PORTH_1_GPIO = 1U,
    PORTH_1_FCUART7_CTS = 2U,
    PORTH_1_eFTU1_IN6 = 3U,
    PORTH_1_FLEXCAN4_RX = 4U,
    PORTH_1_eFTU2_OUT_S24 = 5U,
} PORT_H1MuxType;
...
typedef enum
{
    PORTH_12_ADC3_SE15 = 0U,
    PORTH_12_GPIO = 1U,
    PORTH_12_TPU0_CH27 = 2U,
    PORTH_12_eFTU1_IN7 = 3U,
    PORTH_12_FCUART1_TX = 4U,
    PORTH_12_eFTU2_OUT_S26 = 6U,
    PORTH_12_FCSPI7_PCS3 = 7U,
} PORT_H12MuxType;

/** @brief PORTH13 Mode enumeration */
typedef enum
{
    PORTH_13_ADC5_SE16 = 0U,
    PORTH_13_GPIO = 1U,
    PORTH_13_TPU0_CH26 = 2U,
    PORTH_13_eFTU1_IN0 = 3U,
    PORTH_13_FCUART1_RX = 4U,
    PORTH_13_eFTU2_OUT_S27 = 6U,
} PORT_H13MuxType;

/** @brief PORTH14 Mode enumeration */
typedef enum
{
    PORTH_14_ADC4_SE16 = 0U,
    PORTH_14_GPIO = 1U,
    PORTH_14_TPU0_CH25 = 2U,
    PORTH_14_eFTU1_IN1 = 3U,
    PORTH_14_FCSPI5_PCS3 = 4U,
    PORTH_14_FCUART3_TX = 5U,
    PORTH_14_eFTU2_OUT_S28 = 6U,
} PORT_H14MuxType;
...
typedef enum
{
    PORTH_2_ADC2_SE4_ADC2_DIFF_N0 = 0U,
    PORTH_2_GPIO = 1U,
    PORTH_2_FCUART7_RX = 2U,
    PORTH_2_eFTU1_IN5 = 3U,
    PORTH_2_FCSPI6_PCS3 = 4U,
    PORTH_2_eFTU2_OUT_S23 = 5U,
    PORTH_2_FLEXCAN10_TX = 6U,
} PORT_H2MuxType;
...
typedef enum
{
    PORTH_23_ADC2_SE20 = 0U,
    PORTH_23_GPIO = 1U,
    PORTH_23_eFTU1_IN6 = 2U,
    PORTH_23_QDT1_HOME = 3U,
    PORTH_23_FLEXCAN2_RX = 4U,
    PORTH_23_eFTU2_OUT_S6 = 5U,
    PORTH_23_eFTU1_OUT_S10 = 7U,
} PORT_H23MuxType;
...
typedef enum
{
    PORTH_9_ADC3_SE5_ADC3_DIFF_N1 = 0U,
    PORTH_9_GPIO = 1U,
    PORTH_9_SDADC0_EXT_SIGN = 2U,
    PORTH_9_eFTU2_IN1 = 3U,
    PORTH_9_TPU0_TCRCLK = 4U,
    PORTH_9_FTU1_QD_PHB = 5U,
    PORTH_9_eFTU1_OUT_S23 = 6U,
    PORTH_9_eFTU2_OUT_S1 = 7U,
} PORT_H9MuxType;

/** @brief PORTI0 Mode enumeration */
typedef enum
{
    PORTI_0_ADC2_SE0_ADC2_DIFF_P0 = 0U,
    PORTI_0_GPIO = 1U,
    PORTI_0_FCUART7_TX = 2U,
    PORTI_0_eFTU1_IN3 = 3U,
    PORTI_0_FCSPI6_PCS2 = 4U,
    PORTI_0_eFTU2_OUT_S22 = 5U,
    PORTI_0_FLEXCAN10_RX = 6U,
} PORT_I0MuxType;
...
typedef enum
{
    PORTI_12_ADC3_SE16 = 0U,
    PORTI_12_GPIO = 1U,
    PORTI_12_TPU0_CH24 = 2U,
    PORTI_12_eFTU1_IN2 = 3U,
    PORTI_12_FCSPI5_PCS2 = 4U,
    PORTI_12_FCUART3_RX = 5U,
    PORTI_12_eFTU2_OUT_S29 = 6U,
} PORT_I12MuxType;
...
typedef enum
{
    PORTI_14_ADC3_SE1_ADC3_DIFF_P1 = 0U,
    PORTI_14_GPIO = 1U,
    PORTI_14_eFTU0_OUT_S27 = 3U,
    PORTI_14_FLEXCAN8_RX = 4U,
    PORTI_14_SDADC1_CH2 = 5U,
    PORTI_14_eFTU2_OUT_S15 = 6U,
    PORTI_14_TPU0_CH31 = 7U,
} PORT_I14MuxType;
...
typedef enum
{
    PORTI_3_SSI0_ANA_CH2 = 0U,
    PORTI_3_GPIO = 1U,
    PORTI_3_FCUART11_CTS = 2U,
    PORTI_3_eFTU0_IN2 = 3U,
    PORTI_3_FLEXCAN8_TX = 4U,
    PORTI_3_ETM_TRACE_D14 = 5U,
    PORTI_3_FCSPI6_SOUT = 6U,
    PORTI_3_eFTU1_OUT_S15 = 7U,
} PORT_I3MuxType;

/** @brief PORTI4 Mode enumeration */
typedef enum
{
    PORTI_4_SSI0_ANA_CH3 = 0U,
    PORTI_4_GPIO = 1U,
    PORTI_4_FCUART11_RTS = 2U,
    PORTI_4_eFTU0_IN3 = 3U,
    PORTI_4_FLEXCAN8_RX = 4U,
    PORTI_4_ETM_TRACE_D15 = 5U,
    PORTI_4_FCSPI6_PCS0 = 6U,
    PORTI_4_eFTU1_OUT_S0 = 7U,
} PORT_I4MuxType;

/** @brief PORTI5 Mode enumeration */
typedef enum
{
    PORTI_5_ADC1_SE13 = 0U,
    PORTI_5_GPIO = 1U,
    PORTI_5_FCUART11_RX = 2U,
    PORTI_5_FTU6_CH3 = 3U,
    PORTI_5_SSI0_DIG_14_CH1 = 4U,
    PORTI_5_eFTU2_OUT_S18 = 5U,
    PORTI_5_eFTU0_OUT_S16 = 6U,
    PORTI_5_TPU0_CH23 = 7U,
} PORT_I5MuxType;

/** @brief PORTI6 Mode enumeration */
typedef enum
{
    PORTI_6_ADC5_SE5_ADC5_DIFF_N1 = 0U,
    PORTI_6_GPIO = 1U,
    PORTI_6_FCUART13_RX = 2U,
    PORTI_6_FTU0_CH0 = 3U,
    PORTI_6_MSC0_SOP = 4U,
    PORTI_6_eFTU0_OUT_S25 = 5U,
    PORTI_6_eFTU2_OUT_S3 = 6U,
    PORTI_6_TPU0_CH26 = 7U,
} PORT_I6MuxType;

/** @brief PORTI7 Mode enumeration */
typedef enum
{
    PORTI_7_ADC4_SE0_ADC4_DIFF_P0 = 0U,
    PORTI_7_GPIO = 1U,
    PORTI_7_FCUART13_TX = 2U,
    PORTI_7_FTU0_CH1 = 3U,
    PORTI_7_MSC0_EN0 = 4U,
    PORTI_7_eFTU0_OUT_S26 = 5U,
    PORTI_7_eFTU2_OUT_S4 = 6U,
    PORTI_7_TPU0_CH27 = 7U,
} PORT_I7MuxType;

/** @brief PORTI8 Mode enumeration */
typedef enum
{
    PORTI_8_ADC4_SE4_ADC4_DIFF_N0 = 0U,
    PORTI_8_GPIO = 1U,
    PORTI_8_FCUART13_CTS = 2U,
    PORTI_8_FTU0_CH2 = 3U,
    PORTI_8_MSC0_EN1 = 4U,
    PORTI_8_FLEXCAN9_TX = 5U,
    PORTI_8_SDADC1_PWM_P = 6U,
    PORTI_8_TPU0_CH28 = 7U,
} PORT_I8MuxType;
...
#endif /* _DEVICE_FEATURES_FC7300F8MDQ1A320T1B_H_ */

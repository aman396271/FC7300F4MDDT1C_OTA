#ifndef _DEVICE_FEATURES_FC7300F4MDS2A320T1A_H_
#define _DEVICE_FEATURES_FC7300F4MDS2A320T1A_H_
...
#define GPIOF_PIN_MASK     (uint32_t)(0x1837288u)
/** @brief GpioG Pin MASK structure */
#define GPIOG_PIN_MASK     (uint32_t)(0xff8c06u)
/** @brief GpioH Pin MASK structure */
#define GPIOH_PIN_MASK     (uint32_t)(0x4785b0u)
/** @brief GpioI Pin MASK structure */
#define GPIOI_PIN_MASK     (uint32_t)(0xe3a204u)
...
/*********************** FCSPI Features End ****************************/
#endif /* _DEVICE_FEATURES_FC7300F4MDS2A320T1A_H_ */

#ifndef _DEVICE_FEATURES_FC7300F4MDD2A320T1A_H_
#define _DEVICE_FEATURES_FC7300F4MDD2A320T1A_H_

#include "FC7300F4MDDxxxxxT1B_feature.h"
...
typedef enum
{
    PORTF_12_ADC3_SE14_CMP2_IN5 = 0U,
    PORTF_12_GPIO = 1U,
    PORTF_12_SDDF0_CLK0 = 2U,
} PORT_F12MuxType;

/** @brief PORTF13 Mode enumeration */
typedef enum
{
    PORTF_13_ADC3_SE13_CMP2_IN4 = 0U,
    PORTF_13_GPIO = 1U,
...
typedef enum
{
    PORTF_14_ADC3_SE15_CMP2_IN6 = 0U,
    PORTF_14_GPIO = 1U,
    PORTF_14_SDDF0_BREAK0 = 2U,
...
typedef enum
{
    PORTG_12_ADC3_SE16_CMP2_IN7 = 0U,
    PORTG_12_GPIO = 1U,
    PORTG_12_SDDF0_BREAK1 = 2U,
...
typedef enum
{
    ...
    PORTH_13_GPIO = 1U,
    PORTH_13_SDDF0_CH3 = 2U,
    PORTH_13_FTU9_CH0 = 3U,
...
typedef enum
{
    ...
    PORTH_14_GPIO = 1U,
    PORTH_14_SDDF0_CLK1 = 2U,
    PORTH_14_FTU9_CH1 = 3U,
...
typedef enum
{
    ...
    PORTI_12_GPIO = 1U,
    PORTI_12_SDDF0_CLK2 = 2U,
    PORTI_12_FTU9_CH2 = 3U,
...
#define FCUART_BASE_ADDRS                        {FCUART0_BASE, FCUART1_BASE, FCUART2_BASE, FCUART3_BASE, FCUART4_BASE, FCUART5_BASE, FCUART6_BASE, FCUART7_BASE, FCUART10_BASE, FCUART12_BASE}
/** Array initializer of FCUART peripheral base pointers */
#define FCUART_BASE_PTRS                         {FCUART0, FCUART1, FCUART2, FCUART3, FCUART4, FCUART5, FCUART6, FCUART7, FCUART10, FCUART12}
/** Interrupt vectors for the FCUART peripheral type */
#define FCUART_IRQS                              {FCUART0_IRQn, FCUART1_IRQn, FCUART2_IRQn, FCUART3_IRQn, FCUART4_IRQn, FCUART5_IRQn, FCUART6_IRQn, FCUART7_IRQn,  FCUART10_IRQn, FCUART12_IRQn}
...
typedef enum {
    ...
    FCSPI_INSTANCE_7 = 5  /**< Select FCSPI7 */
} FCSPI_InstanceType;
/** @}*/

/*********************** FCSPI Features End ****************************/

#endif /* _DEVICE_FEATURES_FC7300F4MDD2A320T1A_H_ */

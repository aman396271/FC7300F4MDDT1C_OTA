#ifndef _DEVICE_FEATURES_FC7300F4MDS1A180T1C_H_
#define _DEVICE_FEATURES_FC7300F4MDS1A180T1C_H_

#include "FC7300F4MDSxxxxxT1C_feature.h"

/*********************** PORT Features ****************************/
/** Number of instances of the PORT module. */
#define PORT_INSTANCE_COUNT 6U
...
#define GPIOF_PIN_MASK      (uint32_t)(0x00000088u)

/** @brief Gpio Pin MASK structure */
#define GPIO_PIN_MASK \
    { GPIOA_PIN_MASK, GPIOB_PIN_MASK, GPIOC_PIN_MASK, GPIOD_PIN_MASK, GPIOE_PIN_MASK, GPIOF_PIN_MASK }
...
#endif /* _DEVICE_FEATURES_FC7300F4MDS1A180T1C_H_ */

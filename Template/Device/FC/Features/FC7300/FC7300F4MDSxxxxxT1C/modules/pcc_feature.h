#ifndef _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_PCC_COMMON_H_
#define _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_PCC_COMMON_H_
...
#define PCC_PLLX_CLK2_SUPPORT    (1u)
#define PCC_PLL1_CLK_SUPPORT     (0u)
...
#define PCC_CLOCK_MAP_INFO \
    { \
        ...
        {0xB0, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},   /* TSTMP0 */    \
        ...
        {0x480, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},     /* FLEXCAN3 */  \
        {0x490, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},     /* FLEXCAN4 */  \
        {0x4A0, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE}     /* FLEXCAN5 */   \
    };
...
#endif /* _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_PCC_COMMON_H_ */

#ifndef _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_ADC_COMMON_H_
#define _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_ADC_COMMON_H_
...
#define ADC_SUPPORT_FAST_CMP_BLOCK               (1u)
#define ADC_SUPPORT_INTERNAL_REFERENCE           (0u)
#define ADC_SUPPORT_PERIOD_TRIGGER               (1u)
#define ADC_SUPPORT_GROUP_INJECTION              (1u)

#define ADC_IS_SUPPORT_SG_CMP_BLOCK(i)           \
    (i == 0 || i == 1 ? true : false)            \

#define ADC_IS_SUPPORT_ENHANCED_CMP_BLOCK(i)     \
    (i == 3 ? false : true)                      \

#define ADC_IS_SUPPORT_FAST_CMP_BLOCK(i)         \
    (i == 3 ? true : false)                      \

#define ADC_IS_SUPPORT_PERIOD_TRIGGER(i)         \
    (i == 3 ? true : false)                      \

#define ADC_GET_SUPPORTED_SEQUENCE_GROUP_CNT(i)  \
    (i == 3 ? 2 : ADC_MAX_SEQUENCE_GROUP_CNT)    \
...
#endif /* _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_ADC_COMMON_H_ */

#ifndef _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_FLASH_COMMON_H_
#define _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_FLASH_COMMON_H_

#define FLASHDRV_ADDR   					 	 0x04810C00U /* flash api address in rom */
...
#define FLASH_FC7300F4MDS_T1C                    STD_ON
...
/** 1 DFlash Banks, every bank is 128KB */
#define DFLASH_BANK_NUM                           0x02U
/** DFlash Bank size */
...
/** NVR0 end address */
#define NVR0_FLASH_ADDR_END                        0x04401FFFU
/** NVR2 start address */
#define NVR2_FLASH_ADDR_START                      0x04420000U
/** NVR2 end address */
#define NVR2_FLASH_ADDR_END                        0x04421FFFU
/** Program minimum size */
...
// #define FLASH_DATA_BLOCK_SELECT1          0x005UL
...
typedef struct
{
    ...
    status_t (*FLASH_DRV_DMA_TRIG_FUNC)(FLASH_API_DMA_TRIG_CFG_TYPE * flash_api_cfg);
...
#endif /* _DEVICE_FEATURES_FC7300F4MDSxxxxxT1C_FLASH_COMMON_H_ */

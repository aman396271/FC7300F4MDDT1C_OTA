#ifndef _DEVICE_FEATURES_FC7300F4MDS1A320T1C_H_
#define _DEVICE_FEATURES_FC7300F4MDS1A320T1C_H_
...
typedef enum
{
    PORTA_8_ADC1_SE3_ADC1_DIFF_P3 = 0U,
    PORTA_8_GPIO                  = 1U,
    PORTA_8_FCUART2_RX            = 2U,
    PORTA_8_LP_WAKEUP4            = 5U,
...
typedef enum
{
    PORTA_9_ADC1_SE7_ADC1_DIFF_N3 = 0U,
    PORTA_9_GPIO                  = 1U,
...
typedef enum
{
    PORTB_0_ADC2_SE7_ADC2_DIFF_N3 = 0U,
    PORTB_0_GPIO                  = 1U,
...
typedef enum
{
    PORTB_1_ADC2_SE1_ADC2_DIFF_P1 = 0U,
    PORTB_1_GPIO                  = 1U,
    PORTB_1_FTU_TCK0              = 3U,
...
typedef enum
{
    ...
    PORTB_5_eFTU0_BLDC0_PWM4 = 4U,
    PORTB_5_FTU4_CH4         = 5U,
    PORTB_5_eFTU0_OUT_S1     = 6U,
    PORTB_5_FCUART3_CTS      = 7U,
} PORT_B5MuxType;
...
typedef enum
{
    PORTB_16_ADC2_SE20        = 0U,
    PORTB_16_GPIO             = 1U,
    PORTB_16_FTU5_CH7         = 2U,
    PORTB_16_FCUART5_CTS      = 3U,
    PORTB_16_eFTU0_BLDC0_PWM0 = 4U,
...
typedef enum
{
    PORTB_23_ADC3_SE33        = 0U,
    PORTB_23_GPIO             = 1U,
    PORTB_23_FTU_FLT9         = 2U,
    PORTB_23_FCSPI2_PCS0      = 3U,
    PORTB_23_eFTU0_BLDC1_PWM0 = 4U,
    PORTB_23_FTU2_CH6         = 5U,
...
typedef enum
{
    PORTC_19_ADC3_SE3_ADC3_DIFF_P3 = 0U,
    PORTC_19_GPIO                  = 1U,
    PORTC_19_FTU1_CH6              = 2U,
    PORTC_19_eFTU0_IN3             = 3U,
    PORTC_19_FCSPI5_PCS1           = 4U,
    PORTC_19_eFTU0_OUT_S7          = 5U,
    PORTC_19_eFTU_GTOM12           = 6U,
...
{
    PORTC_28_GPIO             = 1U,
    PORTC_28_ADC3_BFL         = 2U,
    PORTC_28_eFTU0_BLDC1_PWM5 = 3U,
...
typedef enum
{
    PORTD_31_ADC1_SE21   = 0U,
    PORTD_31_GPIO        = 1U,
    PORTD_31_eFTU0_IN2   = 4U,
    PORTD_31_FTU3_CH6    = 5U,
...
typedef enum
{
    PORTE_4_ADC0_SE3_ADC0_DIFF_P3 = 0U,
    PORTE_4_GPIO                  = 1U,
    PORTE_4_FTU2_QD_PHB           = 2U,
    PORTE_4_FTU0_CH1              = 3U,
    PORTE_4_FCUART7_TX            = 4U,
    PORTE_4_SENT0_RXD3            = 5U,
...
typedef enum
{
    ...
    PORTE_11_eFTU0_OUT_S22 = 4U,
    PORTE_11_FCSPI2_PCS0   = 5U,
    PORTE_11_ETM_TRACE_D8  = 6U,
...
{
    PORTF_12_GPIO              = 1U,
    PORTF_12_eFTU0_BLDC1_HALLA = 2U,
    PORTF_12_FTU1_CH3          = 3U,
    PORTF_12_FCSPI2_PCS1       = 4U,
    PORTF_12_FCUART5_RX        = 6U,
...
{
    PORTF_13_GPIO              = 1U,
    PORTF_13_MSC0_FCLP         = 2U,
    PORTF_13_FTU1_CH2          = 3U,
    PORTF_13_FCSPI2_PCS2       = 4U,
    PORTF_13_eFTU_GTOM9        = 5U,
    PORTF_13_eFTU0_BLDC1_HALLC = 6U,
...
typedef enum
{
    ...
    PORTH_4_SSI0_DIG_28_CH0  = 4U,
    PORTH_4_ETM_TRACE_D12    = 5U,
    PORTH_4_FCUART3_TX       = 6U,
    PORTH_4_eFTU0_BLDC0_PWM0 = 7U,
} PORT_H4MuxType;
...
typedef enum
{
    ...
    PORTH_5_SSI0_DIG_14_CH0  = 4U,
    PORTH_5_ETM_TRACE_D13    = 5U,
    PORTH_5_FCUART3_RX       = 6U,
    PORTH_5_eFTU0_BLDC0_PWM1 = 7U,
} PORT_H5MuxType;
...
typedef enum
{
    ...
    PORTH_10_MSC0_SOP              = 3U,
    PORTH_10_SSI0_DIG_14_CH3       = 4U,
...
typedef enum
{
    ...
    PORTH_15_eFTU0_IN1     = 3U,
    PORTH_15_eFTU0_OUT_S25 = 4U,
...
typedef enum
{
    ...
    PORTI_13_SSI0_DIG_28_CH3 = 4U,
    PORTI_13_MSC0_EN1        = 6U,
    PORTI_13_eFTU_GTOM1      = 7U,
} PORT_I13MuxType;
...
typedef enum
{
    ...
    PORTI_23_SSI0_DIG_28_CH2 = 3U,
    PORTI_23_eFTU0_IN0       = 4U,
...
#define PORT_BASE_ADDRS                                           \
    { PORTA_BASE, PORTB_BASE, PORTC_BASE, PORTD_BASE, PORTE_BASE, \
      PORTF_BASE, PORTG_BASE, PORTH_BASE, PORTI_BASE }
...
#define GPIOE_PIN_MASK (uint32_t)(0x0FFFFFFFu)
/** @brief GpioF Pin MASK structure */
#define GPIOF_PIN_MASK (uint32_t)(0x01937ABCu)
/** @brief GpioG Pin MASK structure */
#define GPIOG_PIN_MASK (uint32_t)(0x00FFEF07u)
/** @brief GpioH Pin MASK structure */
#define GPIOH_PIN_MASK (uint32_t)(0x005F85F0u)
/** @brief GpioI Pin MASK structure */
#define GPIOI_PIN_MASK (uint32_t)(0x00FFAE06u)
...
#define GPIO_PIN_MASK                                                                 \
    { GPIOA_PIN_MASK, GPIOB_PIN_MASK, GPIOC_PIN_MASK, GPIOD_PIN_MASK, GPIOE_PIN_MASK, \
      GPIOF_PIN_MASK, GPIOG_PIN_MASK, GPIOH_PIN_MASK, GPIOI_PIN_MASK }
...
#define FCUART_IRQS                                           \
    { FCUART0_IRQn, FCUART1_IRQn, FCUART2_IRQn, FCUART3_IRQn, \
      FCUART4_IRQn, FCUART5_IRQn, FCUART6_IRQn, FCUART7_IRQn }
...
#endif /* _DEVICE_FEATURES_FC7300F4MDS1A320T1C_H_ */

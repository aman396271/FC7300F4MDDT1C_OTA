#ifndef _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_PCC_COMMON_H_
#define _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_PCC_COMMON_H_
...
#define PCC_CLOCK_MAP_INFO \
    { \
        ...
        {0x10C, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE}, /* TMU0 */      \
        ...
        {0x32C, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},     /* SDADC0 */  \
        ...
        {0x374, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},    /* TRGSEL4 */   \
        {0x378, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},    /* TRGSEL5 */   \
        {0x37C, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},    /* TRGSEL6 */   \
        {0x380, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},    /* TRGSEL7 */   \
        {0x384, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_SLOW | PCC_DWP_SWR_AVAILABLE},    /* TRGSEL8 */   \
        {0x38C, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVL_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},         /* SSI0 */  \
        {0x390, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS  | PCC_DWP_SWR_AVAILABLE},    /* CRM0 */   \
        {0x394, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVM_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},         /* LDI0 */  \
        {0x3D0, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVL_USED | PCC_MOUDULE_DIV_USED | PCC_DWP_SWR_AVAILABLE},         /* SENT1 */ \
        {0x3F4, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_FUNCCLK_MUXDIVHPIN_USED | PCC_DWP_SWR_AVAILABLE},  /* FTU4 */  \
        {0x3F8, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_FUNCCLK_MUXDIVH_USED | PCC_FUNCCLK_MUXDIVHPIN_USED | PCC_DWP_SWR_AVAILABLE},  /* FTU5 */  \
        ...
        {0x458, PCC_CGC_AVAILABLE | PCC_CLK_DOMAIN_BUS | PCC_DWP_SWR_AVAILABLE},    /* EFTU0 */  \
...
#endif /* _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_PCC_COMMON_H_ */

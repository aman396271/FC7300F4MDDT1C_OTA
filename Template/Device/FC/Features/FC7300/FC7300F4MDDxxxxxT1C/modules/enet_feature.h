#ifndef _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_ENET_COMMON_H_
#define _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_ENET_COMMON_H_
...
/** ENET buffer in DTCM */
#define ENET_CHECK_ADDR_IN_DTCM(addr)                   (((uint32_t)(addr) >= 0x20000000u) && ((uint32_t)(addr) < 0x20040000u))

/** ENET buffer in SRAM */
#define ENET_CHECK_ADDR_IN_SRAM(addr)                   (((uint32_t)(addr) >= 0x21000000u) && ((uint32_t)(addr) < 0x21080000u))

#endif /* _DEVICE_FEATURES_FC7300F4MDDxxxxxT1C_ENET_COMMON_H_ */

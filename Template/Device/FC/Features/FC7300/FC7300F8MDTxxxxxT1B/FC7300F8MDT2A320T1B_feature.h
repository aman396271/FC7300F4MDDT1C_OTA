#ifndef _DEVICE_FEATURES_FC7300F8MDT2A320T1B_H_
#define _DEVICE_FEATURES_FC7300F8MDT2A320T1B_H_
...
typedef enum
{
    ...
    PORTF_12_FTU10_CH7 = 3U,
    PORTF_12_FCUART17_TX = 5U,
} PORT_F12MuxType;
...
typedef enum
{
    ...
    PORTF_13_GPIO = 1U,
    PORTF_13_FTU10_CH6 = 3U,
    PORTF_13_FCSPI2_PCS2 = 4U,
    PORTF_13_FCUART17_RX = 5U,
} PORT_F13MuxType;
...
typedef enum
{
    ...
    PORTH_10_GPIO = 1U,
    PORTH_10_FTU10_CH2 = 3U,
    PORTH_10_MSC0_SOP = 4U,
    PORTH_10_FCUART17_CTS = 6U,
} PORT_H10MuxType;
...
{
    PORTH_11_GPIO = 1U,
    PORTH_11_FCUART14_RX = 2U,
    PORTH_11_FTU11_CH0 = 3U,
...
typedef enum
{
    ...
    PORTH_4_FTU11_CH0 = 3U,
    PORTH_4_ENET_PPS0 = 4U,
    PORTH_4_TRACE_D12 = 5U,
...
typedef enum
{
    ...
    PORTH_5_FTU11_CH1 = 3U,
    PORTH_5_ENET_PPS1 = 4U,
    PORTH_5_TRACE_D13 = 5U,
...
{
    PORTI_10_GPIO = 1U,
    PORTI_10_FCUART14_CTS = 2U,
    PORTI_10_FTU11_CH2 = 3U,
...
{
    PORTI_11_GPIO = 1U,
    PORTI_11_FCUART14_RTS = 2U,
    PORTI_11_FTU11_CH3 = 3U,
...
typedef enum
{
    ...
    PORTI_3_FTU11_CH2 = 3U,
    PORTI_3_FLEXCAN8_TX = 4U,
    PORTI_3_TRACE_D14 = 5U,
...
typedef enum
{
    ...
    PORTI_4_FTU11_CH3 = 3U,
    PORTI_4_FLEXCAN8_RX = 4U,
    PORTI_4_TRACE_D15 = 5U,
...
{
    PORTI_9_GPIO = 1U,
    PORTI_9_FCUART14_TX = 2U,
    PORTI_9_FTU11_CH1 = 3U,
...
#endif /* _DEVICE_FEATURES_FC7300F8MDT2A320T1A_H_ */

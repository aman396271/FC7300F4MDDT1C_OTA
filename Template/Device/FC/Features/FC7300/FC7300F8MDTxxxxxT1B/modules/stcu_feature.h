#ifndef _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_STCU_COMMON_H_
#define _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_STCU_COMMON_H_
...
typedef enum
{
    ...
    STCU_MBIST_SEL_SRAM2_1     = 0x04U,        /**<! SRAM2_1 SRAM Select for MBIST. >*/
    STCU_MBIST_SEL_SRAM2_2     = 0x08U,        /**<! SRAM2_2 SRAM Select for MBIST. >*/
    ...
    STCU_MBIST_SEL_ITCM_CPU2   = 0x400U,       /**<! ITCM_CPU2 SRAM Select for MBIST. >*/
    STCU_MBIST_SEL_DTCM0_CPU2  = 0x800U,       /**<! DTCM0_CPU2 SRAM Select for MBIST. >*/
    STCU_MBIST_SEL_DTCM1_CPU2  = 0x1000U,      /**<! DTCM1_CPU2 SRAM Select for MBIST. >*/
    ...
    STCU_MBIST_SEL_CACHE_CPU2  = 0x8000U,      /**<! CACHE_CPU2 SRAM Select for MBIST. >*/
...
typedef enum
{
    ...
    STCU_MBIST_DONE_SRAM2_1     = 0x04U,       /**<! SRAM2_1 SRAM MBIST Done Flag. >*/
    STCU_MBIST_DONE_SRAM2_2     = 0x08U,       /**<! SRAM2_2 SRAM MBIST Done Flag. >*/
    ...
    STCU_MBIST_DONE_ITCM_CPU2   = 0x400U,      /**<! ITCM_CPU2 SRAM MBIST Done Flag. >*/
    STCU_MBIST_DONE_DTCM0_CPU2  = 0x800U,      /**<! DTCM0_CPU2 SRAM MBIST Done Flag. >*/
    STCU_MBIST_DONE_DTCM1_CPU2  = 0x1000U,     /**<! DTCM1_CPU2 SRAM MBIST Done Flag. >*/
    ...
    STCU_MBIST_DONE_CACHE_CPU2  = 0x8000U,     /**<! CACHE_CPU2 SRAM MBIST Done Flag. >*/
...
typedef enum
{
    ...
    STCU_INIT_RAM_TYPE_SRAM2_1     = 0x04U,           /**<! SRAM2_1 SRAM Select for Hardware SRAM Initialization. >*/
    STCU_INIT_RAM_TYPE_SRAM2_2     = 0x08U,           /**<! sram2_2 SRAM Select for Hardware SRAM Initialization. >*/
    ...
    STCU_INIT_RAM_TYPE_ITCM_CPU2   = 0x400U,          /**<! ITCM_CPU2 SRAM Select for Hardware SRAM Initialization. >*/
    STCU_INIT_RAM_TYPE_DTCM0_CPU2  = 0x800U,          /**<! DTCM0_CPU2 SRAM Select for Hardware SRAM Initialization. >*/
    STCU_INIT_RAM_TYPE_DTCM1_CPU2  = 0x1000U,         /**<! DTCM1_CPU2 SRAM Select for Hardware SRAM Initialization. >*/
}STCU_InitRamType;
...
typedef enum
{
    ...
    STCU_INIT_RAM_DONE_TYPE_SRAM2_1     = 0x04U,       /**<! SRAM2_1 SRAM Initialization Done Flag. >*/
    STCU_INIT_RAM_DONE_TYPE_SRAM2_2     = 0x08U,       /**<! SRAM2_2 SRAM Initialization Done Flag. >*/
    ...
    STCU_INIT_RAM_DONE_TYPE_ITCM_CPU2   = 0x400U,      /**<! ITCM_CPU2 SRAM Initialization Done Flag. >*/
    STCU_INIT_RAM_DONE_TYPE_DTCM0_CPU2  = 0x800U,      /**<! DTCM0_CPU2 SRAM Initialization Done Flag. >*/
    STCU_INIT_RAM_DONE_TYPE_DTCM1_CPU2  = 0x1000U,     /**<! DTCM1_CPU2 SRAM Initialization Done Flag. >*/
}STCU_InitRamDoneType;

#define STCU_PATTERN_COUNT       (0x0009U)
#define STCU_EXPECTED_MISR_VALUE (0x00E983EAUL)

#endif /* _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_STCU_COMMON_H_ */

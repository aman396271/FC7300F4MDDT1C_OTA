#ifndef _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_ENET_COMMON_H_
#define _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_ENET_COMMON_H_
...
#define ENET_ALL_TXQUEUES_SUPPORT_CHECKSUM              (0u)

/** TCM memory support SMP mode */
#define ENET_SUPPORT_TCM_SMP_MODE                       (0u)

/** ENET DTCM back door address offset */
#define ENET_DTCM_BACKDOOR_OFFSET(coreId, smp)          (0x2000000u + ((coreId) * (0x100000u)))

/** ENET buffer in DTCM */
#define ENET_CHECK_ADDR_IN_DTCM(addr)                   (((uint32_t)(addr) >= 0x20000000u) && ((uint32_t)(addr) < 0x20020000u))

/** ENET buffer in SRAM */
#define ENET_CHECK_ADDR_IN_SRAM(addr)                   (((uint32_t)(addr) >= 0x21000000u) && ((uint32_t)(addr) < 0x21080000u))

#endif /* _DEVICE_FEATURES_FC7300F8MDTxxxxxT1B_ENET_COMMON_H_ */
